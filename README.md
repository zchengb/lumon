...
```text
curl -fsSL https://raw.githubusercontent.com/zchengb/lumon/release/packaging/install.sh | bash -s -- --version v1.0.6
```
...
semantic version tag such as `v1.0.6` runs the release workflow, which attaches
