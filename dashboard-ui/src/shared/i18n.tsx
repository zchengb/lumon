...
const zhCN = {
  ...
  "flows.eyebrow": "工作区流程",
  "flows.title": "Flows",
  "flows.subtitle": "使用 Markdown 定义可匹配、可编辑的工作区流程。",
  "flows.unsaved": "有未保存更改",
  "flows.select": "选择流程",
  "flows.refresh": "刷新流程",
  "flows.installSample": "安装示例流程",
  "flows.new": "新建流程",
  "flows.empty": "还没有流程",
  "flows.valid": "有效",
  "flows.invalid": "无效",
  ...
  "flows.created": "流程已创建。",
  "flows.deleted": "流程已删除。",
  "flows.sampleInstalled": "示例测试用例流程已安装。",
...
const messages: Record<Locale, MessageSet> = {
  ...
  "zh-TW": {
    ...
    "flows.eyebrow": "工作區流程",
    "flows.title": "Flows",
    "flows.subtitle": "使用 Markdown 定義可比對、可編輯的工作區流程。",
    "flows.unsaved": "有未儲存變更",
    "flows.select": "選擇流程",
    "flows.refresh": "重新整理流程",
    "flows.installSample": "安裝範例流程",
    "flows.new": "新增流程",
    "flows.empty": "尚無流程",
    "flows.valid": "有效",
    "flows.invalid": "無效",
    ...
    "flows.created": "流程已建立。",
    "flows.deleted": "流程已刪除。",
    "flows.sampleInstalled": "範例測試案例流程已安裝。",
  ...
  en: {
    ...
    "flows.installSample": "Install sample flow",
    "flows.new": "New flow",
    ...
    "flows.sampleInstalled": "Sample test-case flow installed.",
