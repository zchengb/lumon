...
const zhCN = {
  ...
  "app.agentSettingsSaved": "Agent 配置已保存，请重启 Mark 使其生效。",
  ...
  "agent.title": "Mark Agent",
  "agent.subtitle": "适用于本机 Agent 以及所有工作区。",
  "agent.toggleAria": "启用 Mark Agent",
  "agent.runtime": "运行时",
  ...
  "agent.secretSaved": "已保存",
  "agent.secretMissing": "未保存",
  "agent.secretReplacePlaceholder": "输入新 Secret 以替换已保存值",
  "agent.secretNewPlaceholder": "输入 App Secret",
  "agent.restartHelp": "保存后请重启 Mark Agent，新的 Agent 配置才会生效。",
  ...
  "agent.credentialsConfigured": "凭据已配置",
  "agent.credentialsMissing": "凭据未配置",
  "agent.credentialsHelp": "已保存的密钥不会回显；环境变量中的密钥也会计入配置状态。",
...
const messages: Record<Locale, MessageSet> = {
  ...
  "zh-TW": {
    ...
    "app.agentSettingsSaved": "Agent 設定已儲存，請重新啟動 Mark 使其生效。",
    ...
    "agent.toggleAria": "啟用 Mark Agent",
    "agent.runtime": "執行環境",
    ...
    "agent.secretSaved": "已儲存",
    "agent.secretMissing": "未儲存",
    "agent.secretReplacePlaceholder": "輸入新的 Secret 以替換已儲存值",
    "agent.secretNewPlaceholder": "輸入 App Secret",
    "agent.restartHelp": "儲存後請重新啟動 Mark Agent，新的 Agent 設定才會生效。",
    ...
    "agent.credentialsConfigured": "憑據已設定",
    "agent.credentialsMissing": "憑據未設定",
    "agent.credentialsHelp": "已儲存的密鑰不會回顯；環境變數中的密鑰也會計入設定狀態。",
    "agent.langfuseEndpoint": "Langfuse Endpoint",
    "agent.langfusePublicKey": "Langfuse Public Key",
    "agent.langfuseSecretKey": "Langfuse Secret Key",
    "agent.keySaved": "已設定",
    "agent.keyMissing": "未設定",
    "agent.keyReplacePlaceholder": "輸入新的 Key 以替換已儲存值",
    "agent.keyNewPlaceholder": "輸入 Langfuse Key",
    "agent.sampleRate": "取樣率",
    "agent.clearLangfuseCredentials": "清除已儲存的 Langfuse 憑據",
    "agent.save": "儲存 Agent 設定",
    "flows.eyebrow": "工作區流程",
    "flows.title": "Flows",
  ...
  en: {
    ...
    "app.agentSettingsSaved": "Agent settings saved. Restart Mark to apply them.",
    ...
    "agent.toggleAria": "Enable Mark Agent",
    ...
    "agent.secretSaved": "Saved",
    "agent.secretMissing": "Not saved",
    "agent.secretReplacePlaceholder": "Enter a new secret to replace the saved value",
    "agent.secretNewPlaceholder": "Enter App Secret",
    "agent.restartHelp": "Restart Mark Agent after saving for the new Agent settings to take effect.",
    ...
    "agent.credentialsConfigured": "Credentials configured",
    "agent.credentialsMissing": "Credentials missing",
    "agent.credentialsHelp": "Saved keys are never shown again; environment credentials also count as configured.",
    "agent.langfuseEndpoint": "Langfuse endpoint",
    "agent.langfusePublicKey": "Langfuse public key",
    "agent.langfuseSecretKey": "Langfuse secret key",
    "agent.keySaved": "Configured",
    "agent.keyMissing": "Not configured",
    "agent.keyReplacePlaceholder": "Enter a new key to replace the saved value",
