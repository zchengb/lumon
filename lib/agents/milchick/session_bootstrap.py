...
def build_bootstrap_prompt(
    *,
    ...
    return (
        ...
        "- Jira create/edit → emit jira.workitem.create / jira.workitem.update "
        "yourself (do not ask Mark).\n"
        ...
        "- Prefer <ACTION_REQUEST> for job create/list/show/cancel/retry and Jira "
        "create/update.\n"
...
def build_resume_prompt(*, user_message: str, project_slug: str = "", checkpoint: dict[str, Any] | None = None) -> str:
    ...
    return (
        ...
        "Jira create/update is yours via ACTION_REQUEST.\n"
