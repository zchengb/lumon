...
function Tv({ label: e, provider: t, model: n, baseUrl: r, apiKeyEnv: i, reasoningEffort: a, accountEmail: o, onProviderChange: s, onModelChange: c, onBaseUrlChange: l, onApiKeyEnvChange: u, onReasoningEffortChange: d, onAccountEmailChange: f, markDirty: p }) {
	let { t: m } = Z(), h = (e) => {
		s(e), c(e === "codex" ? "gpt-5.6-luna" : e === "opencode" ? "deepseek-v4-flash" : e === "cursor_cli" ? "cursor-grok-4.5-medium" : e === "openai_compatible" ? "gpt-4o-mini" : n), d(e === "codex" ? "xhigh" : ""), f(e === "codex" ? Qg : ""), p();
	};
	return /* @__PURE__ */ (0, J.jsxs)("div", {
