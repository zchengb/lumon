...
var le = /* @__PURE__ */ n(((e) => {
	...
	var st = Math.random().toString(36).slice(2), ct = "__reactFiber$" + st, lt = "__reactProps$" + st, ut = "__reactContainer$" + st, dt = "__reactEvents$" + st, ft = "__reactListeners$" + st, L = "__reactHandles$" + st, pt = "__reactResources$" + st, mt = "__reactMarker$" + st;
	function ht(e) {
		delete e[ct], delete e[lt], delete e[dt], delete e[ft], delete e[L];
	}
	function gt(e) {
		var t = e[ct];
		if (t) return t;
...
function kv({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	...
	}), [$e, et] = (0, F.useState)(""), [tt, nt] = (0, F.useState)(""), [rt, it] = (0, F.useState)({
		enabled: !!c.enabled,
	...
	}), [st, ct] = (0, F.useState)(""), [lt, ut] = (0, F.useState)(!1), [dt, ft] = (0, F.useState)(!1), L = () => {
		ft(!0), r(!0);
	}, pt = (e) => {
	...
	}, ht = (Ze.users?.length ? Ze.users : Ze.user_ids.map((e) => ({
		id: e,
		name: pt(e)
	}))).filter((e) => e.id), gt = (Ze.chats?.length ? Ze.chats : Ze.chat_ids.map((e) => ({
		id: e,
		name: pt(e)
	}))).filter((e) => e.id), _t = Array.from(/* @__PURE__ */ new Set([
		...Ye.allowed_user_ids || [],
		...Ye.mutation_allowed_user_ids || [],
		...Ye.admin_user_ids || []
	])), vt = /* @__PURE__ */ new Map();
	for (let e of ht) e.id && vt.set(String(e.id), e);
	for (let e of _t) vt.has(e) || vt.set(e, {
		id: e,
		name: pt(e)
	});
	let yt = Array.from(vt.values()).filter((e) => e.id), bt = [];
	for (let e of yt) {
		let t = String(e.id), n = String(e.union_id || "").trim() || `id:${t}`, r = a("settings.pendingAccess"), i = String(e.name || pt(t) || r), o = bt.find((e) => e.key === n);
		o ? (o.ids.push(t), i !== r && (o.name = i)) : bt.push({
			key: n,
			name: i,
			ids: [t],
			pending: !1
	...
	for (let e of bt) e.pending = e.ids.some((e) => !_t.includes(e));
	let xt = Array.from(/* @__PURE__ */ new Set([...Ye.allowed_chat_ids || [], ...Ze.chat_ids || []])).map((e) => gt.find((t) => String(t.id) === e) || {
		id: e,
		name: pt(e)
	}), St = (e, t) => (Ye[e] || []).includes(t), Ct = (e, t, n) => {
		Xe((r) => {
			let i = r[e] || [];
			return {
				...r,
	...
	}, wt = bt.filter((e) => e.ids.some((e) => _t.includes(e))), Tt = (e) => {
	...
	(0, F.useEffect)(() => {
		...
		let e = (e) => {
			dt && (e.preventDefault(), e.returnValue = "");
		};
		return window.addEventListener("beforeunload", e), () => window.removeEventListener("beforeunload", e);
	}, [dt]);
	let Dt = async (e) => {
	...
	}), Wt = Ge !== rt.enabled || JSON.stringify(qe) !== rt.agents || JSON.stringify(Ye) !== rt.access || JSON.stringify({
		language: at.language || "zh-Hant",
		table_name: at.table_name || "Sheet1",
		base_app_token_env: at.base_app_token_env || "FEISHU_MBPASS_QA_SHEET_TOKEN"
	}) !== (() => {
		try {
			let e = JSON.parse(rt.testCase || "{}");
		...
		if (!lt) {
			...
			try {
					...
					let e = await l_("/api/agents", t, {
						...
						json: {
							...
							test_case: {
								...
								table_name: at.table_name || "Sheet1",
								base_app_token_env: at.base_app_token_env || "FEISHU_MBPASS_QA_SHEET_TOKEN",
								...st.trim() ? { base_app_token: st.trim() } : {}
							},
							agents: qe.map((e) => {
								let t = {
									id: e.id,
				...
				I({}), ft(!1), r(!1), n("Settings saved", "success"), i();
			} catch (e) {
	...
	return /* @__PURE__ */ (0, J.jsxs)("div", {
		...
		children: [
						...
						/* @__PURE__ */ (0, J.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, J.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, J.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, J.jsx)($, {
											...
											children: /* @__PURE__ */ (0, J.jsxs)("select", {
												...
												}), bt.map((e) => /* @__PURE__ */ (0, J.jsx)("optgroup", {
											...
											children: /* @__PURE__ */ (0, J.jsxs)("select", {
												...
												}), xt.map((e) => /* @__PURE__ */ (0, J.jsx)("option", {
													value: String(e.id),
													children: e.name || pt(String(e.id)) || mt(String(e.id))
												}, String(e.id)))]
											})
										})]
									}),
									$e && /* @__PURE__ */ (0, J.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, J.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, J.jsx)("span", { children: a("settings.identityRoles") }), /* @__PURE__ */ (0, J.jsx)("code", { children: mt($e) })]
											}),
											/* @__PURE__ */ (0, J.jsxs)("label", { children: [/* @__PURE__ */ (0, J.jsx)("input", {
												type: "checkbox",
									...
									tt && /* @__PURE__ */ (0, J.jsxs)("div", {
										className: "access-identity-editor",
										children: [/* @__PURE__ */ (0, J.jsxs)("div", {
											className: "access-identity-heading",
											children: [/* @__PURE__ */ (0, J.jsx)("span", { children: a("settings.accessChat") }), /* @__PURE__ */ (0, J.jsx)("code", { children: mt(tt) })]
										}), /* @__PURE__ */ (0, J.jsxs)("label", { children: [/* @__PURE__ */ (0, J.jsx)("input", {
											type: "checkbox",
											checked: (Ye.allowed_chat_ids || []).includes(tt),
											onChange: (e) => Ct("allowed_chat_ids", tt, e.target.checked)
									...
									yt.length === 0 && /* @__PURE__ */ (0, J.jsx)("p", {
							...
							children: [/* @__PURE__ */ (0, J.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, J.jsx)($, {
										...
										help: at.base_app_token_configured ? `Configured (${at.base_app_token_masked || "set"}). Leave blank to keep. Env: ${at.base_app_token_env || "FEISHU_MBPASS_QA_SHEET_TOKEN"}` : `Stored in ~/.lumon/.env.local as ${at.base_app_token_env || "FEISHU_MBPASS_QA_SHEET_TOKEN"}`,
										children: /* @__PURE__ */ (0, J.jsx)("input", {
											value: st,
											placeholder: at.base_app_token_configured ? "Leave blank to keep current token" : "https://…/sheets/TOKEN or TOKEN",
											onChange: (e) => {
												ct(e.target.value), L();
											},
											autoComplete: "off"
			...
			/* @__PURE__ */ (0, J.jsxs)("footer", {
				...
				children: [/* @__PURE__ */ (0, J.jsx)("span", {
					className: dt ? "settings-save-status unsaved" : "settings-save-status",
					children: a(lt ? "common.saving" : dt ? "settings.unsavedChanges" : "settings.allSaved")
				}), /* @__PURE__ */ (0, J.jsxs)("button", {
					className: `button primary${lt ? " is-busy" : ""}`,
					disabled: !dt || lt,
					onClick: () => void Gt(),
					children: [lt ? /* @__PURE__ */ (0, J.jsx)(ag, {
						size: 15,
						className: "spin"
					}) : /* @__PURE__ */ (0, J.jsx)(ug, { size: 15 }), a(lt ? "common.saving" : "action.saveChanges")]
				})]
			})
		]
	});
