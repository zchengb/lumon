...
var le = /* @__PURE__ */ n(((e) => {
	...
	var st = Math.random().toString(36).slice(2), ct = "__reactFiber$" + st, lt = "__reactProps$" + st, ut = "__reactContainer$" + st, L = "__reactEvents$" + st, dt = "__reactListeners$" + st, ft = "__reactHandles$" + st, pt = "__reactResources$" + st, mt = "__reactMarker$" + st;
	function ht(e) {
				...
				if (hl(t, e), vl(e), r & 512 && (el || n === null || Gc(n, n.return)), r & 4) {
					...
					if (r = e.memoizedState, n === null) if (r === null) if (e.stateNode === null) {
						a: {
							...
							b: switch (r) {
								case "title":
									o = a.getElementsByTagName("title")[0], (!o || o[mt] || o[ct] || o.namespaceURI === "http://www.w3.org/2000/svg" || o.hasAttribute("itemprop")) && (o = a.createElement(r), a.head.insertBefore(o, a.querySelector("head > title"))), Rd(o, r, n), o[ct] = e, bt(o), r = o;
									break a;
								case "link":
...
function kv({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	let { t: a } = Z(), o = e.interactive?.workspace || {}, s = e.interactive?.schedules || {}, c = e.interactive?.agents || {}, l = o.runtime && typeof o.runtime == "object" ? o.runtime : {}, [u, d] = (0, F.useState)(String(o.scan_window_days || 7)), [f, p] = (0, F.useState)(String(s.scan?.cron || "0 12 * * 1-5")), [m, h] = (0, F.useState)(!!s.scan), [g, _] = (0, F.useState)(String(Math.round((s.delivery?.interval_seconds || 300) / 60))), [v, y] = (0, F.useState)(Array.isArray(s.delivery?.jira_statuses) ? s.delivery.jira_statuses.map(String) : String(s.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean)), [b, x] = (0, F.useState)(String(s.delivery?.in_dev_status || "")), [S, C] = (0, F.useState)(String(s.delivery?.dev_done_status || "")), [w, T] = (0, F.useState)(String(s.delivery?.blocked_status || "Block")), [E, ee] = (0, F.useState)(!!s.delivery?.enabled), [D, O] = (0, F.useState)(String(Math.round((s.patch?.interval_seconds || 300) / 60))), [te, k] = (0, F.useState)(Array.isArray(s.patch?.jira_statuses) ? s.patch.jira_statuses.map(String) : ["To Do"]), [A, j] = (0, F.useState)(String(s.patch?.in_progress_status || "In Progress")), [M, N] = (0, F.useState)(String(s.patch?.done_status || "Done")), [ne, re] = (0, F.useState)(String(s.patch?.blocked_status || "Block")), [ie, ae] = (0, F.useState)(!!s.patch?.enabled), P = n_(o, "scan"), [oe, se] = (0, F.useState)(P.provider), [ce, le] = (0, F.useState)(P.model), [ue, de] = (0, F.useState)(P.base_url), [fe, pe] = (0, F.useState)(P.api_key_env), [me, he] = (0, F.useState)(P.reasoning_effort), [ge, _e] = (0, F.useState)(P.account_email), [ve, ye] = (0, F.useState)([]), [be, xe] = (0, F.useState)({}), [Se, I] = (0, F.useState)({}), [Ce, we] = (0, F.useState)(String(o.publish?.scan || "pr")), [Te, Ee] = (0, F.useState)(String(o.publish?.delivery || "pr")), [De, Oe] = (0, F.useState)(String(o.publish?.patch || "pr")), [ke, Ae] = (0, F.useState)(o.feishu_notifications_enabled !== !1), [je, Me] = (0, F.useState)(!!o.deployment_tracking?.enabled), [Ne, Pe] = (0, F.useState)(String(o.deployment_tracking?.provider || "none")), [Fe, Ie] = (0, F.useState)(String(o.deployment_tracking?.poll_interval_seconds || 30)), [Le, Re] = (0, F.useState)(String(o.deployment_tracking?.timeout_seconds || 3600)), [ze, Be] = (0, F.useState)(String(o.deployment_tracking?.jenkins?.job || "")), [Ve, He] = (0, F.useState)(String(o.deployment_tracking?.github_actions?.repository || "")), [Ue, We] = (0, F.useState)(String(o.deployment_tracking?.github_actions?.workflow || "")), [Ge, Ke] = (0, F.useState)(!!c.enabled), [qe, Je] = (0, F.useState)(Array.isArray(c.agents) ? c.agents.map((e) => ({ ...e })) : []), [Ye, Xe] = (0, F.useState)({
	...
	}), [$e, et] = (0, F.useState)(""), [tt, nt] = (0, F.useState)({
		enabled: !!c.enabled,
	...
	}), [at, ot] = (0, F.useState)(""), [st, ct] = (0, F.useState)(!1), [lt, ut] = (0, F.useState)(!1), L = () => {
		ut(!0), r(!0);
	}, dt = (e) => {
		let t = String(Ze.names?.[e] || "").trim();
		if (t) return t;
		let n = (Ze.users || []).find((t) => t.id === e);
		if (n?.name) return String(n.name).trim();
		let r = (Ze.chats || []).find((t) => t.id === e);
		return String(r?.name || "").trim();
	}, ft = (e) => {
		let t = String(e || "").trim();
		return t.length <= 14 ? t : `${t.slice(0, 10)}…${t.slice(-4)}`;
	}, pt = (Ze.users?.length ? Ze.users : Ze.user_ids.map((e) => ({
		id: e,
		name: dt(e)
	}))).filter((e) => e.id), mt = (e) => {
	...
	}, ht = (Ze.chats?.length ? Ze.chats : Ze.chat_ids.map((e) => ({
		id: e,
		name: dt(e)
	}))).filter((e) => e.id && !mt(e)), gt = Array.from(/* @__PURE__ */ new Set([
		...Ye.allowed_user_ids || [],
		...Ye.mutation_allowed_user_ids || [],
		...Ye.admin_user_ids || []
	])), _t = /* @__PURE__ */ new Map();
	for (let e of pt) e.id && _t.set(String(e.id), e);
	for (let e of gt) _t.has(e) || _t.set(e, {
		id: e,
		name: dt(e)
	});
	let vt = Array.from(_t.values()).filter((e) => e.id), yt = [];
	for (let e of vt) {
		let t = String(e.id), n = String(e.union_id || "").trim() || `id:${t}`, r = a("settings.pendingAccess"), i = String(e.name || dt(t) || r), o = yt.find((e) => e.key === n);
		o ? (o.ids.push(t), i !== r && (o.name = i)) : yt.push({
			key: n,
			name: i,
			ids: [t],
			pending: !1
	...
	for (let e of yt) e.pending = e.ids.some((e) => !gt.includes(e));
	let bt = new Set((Ze.direct_chat_ids || []).map(String)), xt = Array.from(/* @__PURE__ */ new Set([...Ze.chat_ids || [], ...Ye.allowed_chat_ids || []])).filter((e) => !bt.has(String(e))).map((e) => ht.find((t) => String(t.id) === e) || {
		id: e,
		name: dt(e),
		agents: []
	}).filter((e) => !mt(e)), St = (e, t) => (Ye[e] || []).includes(t), Ct = (e, t, n) => {
		Xe((r) => {
			let i = r[e] || [];
			return {
				...r,
	...
	}, wt = yt.filter((e) => e.ids.some((e) => gt.includes(e))), Tt = (e) => {
	...
	(0, F.useEffect)(() => {
		l_("/api/delivery/status-options", t).then((e) => ye(Array.isArray(e.options) ? e.options.map(String) : [])).catch(() => ye([]));
	}, [t]), (0, F.useEffect)(() => {
		let e = !1;
		...
		let t = n_(o, "scan");
		d(String(o.scan_window_days || 7)), p(String(s.scan?.cron || "0 12 * * 1-5")), h(!!s.scan), _(String(Math.round((s.delivery?.interval_seconds || 300) / 60))), y(Array.isArray(s.delivery?.jira_statuses) ? s.delivery.jira_statuses.map(String) : String(s.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean)), x(String(s.delivery?.in_dev_status || "")), C(String(s.delivery?.dev_done_status || "")), T(String(s.delivery?.blocked_status || "Block")), ee(!!s.delivery?.enabled), O(String(Math.round((s.patch?.interval_seconds || 300) / 60))), k(Array.isArray(s.patch?.jira_statuses) ? s.patch.jira_statuses.map(String) : ["To Do"]), j(String(s.patch?.in_progress_status || "In Progress")), N(String(s.patch?.done_status || "Done")), re(String(s.patch?.blocked_status || "Block")), ae(!!s.patch?.enabled), se(t.provider), le(t.model), de(t.base_url), pe(t.api_key_env), he(t.reasoning_effort), _e(t.account_email), Ae(o.feishu_notifications_enabled !== !1), xe({}), I({}), e.interactive?.agents && Tt(e.interactive.agents), ut(!1), r(!1);
	}, [t]), (0, F.useEffect)(() => {
		we(String(o.publish?.scan || "pr")), Ee(String(o.publish?.delivery || "pr")), Oe(String(o.publish?.patch || "pr"));
	}, [
		o.publish?.scan,
		o.publish?.delivery,
		o.publish?.patch
	]), (0, F.useEffect)(() => {
		Ae(o.feishu_notifications_enabled !== !1);
	}, [o.feishu_notifications_enabled]), (0, F.useEffect)(() => {
		let e = o.deployment_tracking || {};
		Me(!!e.enabled), Pe(String(e.provider || "none")), Ie(String(e.poll_interval_seconds || 30)), Re(String(e.timeout_seconds || 3600)), Be(String(e.jenkins?.job || "")), He(String(e.github_actions?.repository || "")), We(String(e.github_actions?.workflow || ""));
	}, [JSON.stringify(o.deployment_tracking || {})]), (0, F.useEffect)(() => {
		let e = (e) => {
			lt && (e.preventDefault(), e.returnValue = "");
		};
		return window.addEventListener("beforeunload", e), () => window.removeEventListener("beforeunload", e);
	}, [lt]);
	let Dt = async (e) => {
	...
	}, At = o.configured_integrations || [], jt = o.integration_sources || {}, Mt = At.includes("JENKINS_URL") && At.includes("JENKINS_AUTH"), Nt = Array.from(new Set([
		"To Do",
		"Backlog",
		"In Progress",
		"Done",
		...
		M,
		ne
	].filter(Boolean))), Pt = Array.isArray(s.delivery?.jira_statuses) ? s.delivery.jira_statuses.map(String) : String(s.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean), Ft = Array.isArray(s.patch?.jira_statuses) ? s.patch.jira_statuses.map(String) : ["To Do"], It = (e, t) => e.length === t.length && e.every((e, n) => e === t[n]), Lt = m !== !!s.scan || m && f !== String(s.scan?.cron || "0 12 * * 1-5"), Rt = E !== !!s.delivery?.enabled || E && (g !== String(Math.round((s.delivery?.interval_seconds || 300) / 60)) || !It(v, Pt) || b !== String(s.delivery?.in_dev_status || "") || S !== String(s.delivery?.dev_done_status || "") || w !== String(s.delivery?.blocked_status || "Block")), zt = ie !== !!s.patch?.enabled || ie && (D !== String(Math.round((s.patch?.interval_seconds || 300) / 60)) || !It(te, Ft) || A !== String(s.patch?.in_progress_status || "In Progress") || M !== String(s.patch?.done_status || "Done") || ne !== String(s.patch?.blocked_status || "Block")), Bt = Ce !== String(o.publish?.scan || "pr") || Te !== String(o.publish?.delivery || "pr") || De !== String(o.publish?.patch || "pr"), Vt = {
		enabled: je,
		provider: Ne,
		poll_interval_seconds: Number(Fe),
		timeout_seconds: Number(Le),
		jenkins: { job: ze },
		github_actions: {
			repository: Ve,
			workflow: Ue
		}
	}, Ht = o.deployment_tracking || {}, Ut = JSON.stringify(Vt) !== JSON.stringify({
		enabled: !!Ht.enabled,
		provider: String(Ht.provider || "none"),
		poll_interval_seconds: Number(Ht.poll_interval_seconds || 30),
		timeout_seconds: Number(Ht.timeout_seconds || 3600),
		jenkins: { job: String(Ht.jenkins?.job || "") },
		github_actions: {
			repository: String(Ht.github_actions?.repository || ""),
			workflow: String(Ht.github_actions?.workflow || "")
		}
	}), Wt = Ge !== tt.enabled || JSON.stringify(qe) !== tt.agents || JSON.stringify(Ye) !== tt.access || JSON.stringify({
		language: rt.language || "zh-Hant",
		table_name: rt.table_name || "Sheet1",
		base_app_token_env: rt.base_app_token_env || "FEISHU_MBPASS_QA_SHEET_TOKEN"
	}) !== (() => {
		try {
			let e = JSON.parse(tt.testCase || "{}");
		...
		if (!st) {
			ct(!0);
			try {
				if (!ce.trim()) throw Error("Choose a preset or enter a supported global model ID.");
				let e = [() => l_("/api/workspace", t, {
					method: "POST",
					json: {
						scan_window_days: Number(u),
						ai_provider: oe,
						ai_model: ce.trim(),
						ai_base_url: ue.trim(),
						ai_api_key_env: fe.trim(),
						ai_reasoning_effort: me.trim(),
						ai_account_email: ge.trim(),
						feishu_notifications_enabled: ke
					}
				}), ...Object.entries(Se).map(([e, n]) => () => l_("/api/integration", t, {
					method: "POST",
					json: {
						key: e,
						value: n
				...
				})), Rt && e.push(() => l_("/api/schedule", t, {
					method: "POST",
					json: E ? {
						kind: "delivery",
						action: "save",
						interval_minutes: Number(g),
						jira_statuses: v,
						in_dev_status: b,
						dev_done_status: S,
						blocked_status: w
				...
				})), Bt && e.push(() => l_("/api/publish-policy", t, {
					method: "POST",
					json: {
						scan_mode: Ce,
						delivery_mode: Te,
				...
				})), Ut && e.push(() => l_("/api/deployment-config", t, {
					method: "POST",
					json: Vt
				})), Wt && e.push(async () => {
					let e = await l_("/api/agents", t, {
						...
						json: {
							...
							test_case: {
								...
								table_name: rt.table_name || "Sheet1",
								base_app_token_env: rt.base_app_token_env || "FEISHU_MBPASS_QA_SHEET_TOKEN",
								...at.trim() ? { base_app_token: at.trim() } : {}
							},
							agents: qe.map((e) => {
								let t = {
									id: e.id,
				...
				I({}), ut(!1), r(!1), n("Settings saved", "success"), i();
			} catch (e) {
	...
	return /* @__PURE__ */ (0, J.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, J.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, J.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, J.jsxs)("strong", { children: [Kt, "/3"] }),
					...
					/* @__PURE__ */ (0, J.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, J.jsx)("strong", { children: a(Te === "direct" ? "settings.direct" : Te === "merge" ? "settings.merge" : "settings.pullRequest") }),
						/* @__PURE__ */ (0, J.jsx)("small", { children: a("label.autoDelivery") })
					] }),
					/* @__PURE__ */ (0, J.jsxs)("div", { children: [
						/* @__PURE__ */ (0, J.jsx)("span", { children: a("common.integrations") }),
						/* @__PURE__ */ (0, J.jsx)("strong", { children: At.length }),
						...
						/* @__PURE__ */ (0, J.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, J.jsxs)("div", {
									...
									}), /* @__PURE__ */ (0, J.jsx)("p", { children: E ? `Polling every ${g} minute(s).` : a("settings.deliveryPaused") })]
								}),
								/* @__PURE__ */ (0, J.jsxs)("div", {
									className: "settings-control wide",
									children: [/* @__PURE__ */ (0, J.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, J.jsx)($, {
												...
												children: /* @__PURE__ */ (0, J.jsx)("select", {
													...
													children: Nt.map((e) => /* @__PURE__ */ (0, J.jsx)("option", {
														value: e,
														children: e
													}, e))
												})
											...
											/* @__PURE__ */ (0, J.jsx)($, {
												...
												children: /* @__PURE__ */ (0, J.jsx)("select", {
													...
													children: Array.from(/* @__PURE__ */ new Set([...Nt, "Block"])).map((e) => /* @__PURE__ */ (0, J.jsx)("option", {
														value: e,
														children: e
													}, e))
												})
						...
						/* @__PURE__ */ (0, J.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, J.jsxs)("div", {
									...
									}), /* @__PURE__ */ (0, J.jsx)("p", { children: ie ? `Polling every ${D} minute(s) for Task and Bug cards.` : a("settings.patchPaused") })]
								}),
								/* @__PURE__ */ (0, J.jsxs)("div", {
									className: "settings-control wide",
									children: [/* @__PURE__ */ (0, J.jsxs)("div", {
						...
						/* @__PURE__ */ (0, J.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, J.jsxs)("div", {
								...
								children: [
									...
									!!(Ye.legacy_warning ?? c.access?.legacy_warning) && /* @__PURE__ */ (0, J.jsx)("p", {
										className: "schedule-note",
									...
									/* @__PURE__ */ (0, J.jsx)("div", {
										...
										children: /* @__PURE__ */ (0, J.jsx)($, {
											...
											children: /* @__PURE__ */ (0, J.jsxs)("select", {
												...
												}), yt.map((e) => /* @__PURE__ */ (0, J.jsx)("optgroup", {
									...
									/* @__PURE__ */ (0, J.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, J.jsxs)("section", {
											...
											children: [/* @__PURE__ */ (0, J.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, J.jsxs)("div", { children: [/* @__PURE__ */ (0, J.jsx)("strong", { children: a("settings.groupChats") }), /* @__PURE__ */ (0, J.jsx)("span", { children: a("settings.groupChatsDescription") })] }), /* @__PURE__ */ (0, J.jsx)(u_, { value: `${xt.filter((e) => (Ye.allowed_chat_ids || []).includes(String(e.id))).length}/${xt.length}` })]
											}), /* @__PURE__ */ (0, J.jsx)("div", {
												...
												children: xt.length ? xt.map((e) => {
													...
													return /* @__PURE__ */ (0, J.jsxs)("label", {
														...
														children: [/* @__PURE__ */ (0, J.jsxs)("span", {
															...
															children: [
																/* @__PURE__ */ (0, J.jsx)("strong", { children: e.name || dt(t) || ft(t) }),
															...
															type: "checkbox",
															checked: (Ye.allowed_chat_ids || []).includes(t),
															onChange: (e) => Ct("allowed_chat_ids", t, e.target.checked),
											...
											children: [/* @__PURE__ */ (0, J.jsxs)("div", {
												className: "access-permission-heading",
												children: [/* @__PURE__ */ (0, J.jsxs)("div", { children: [/* @__PURE__ */ (0, J.jsx)("strong", { children: a("settings.privateContacts") }), /* @__PURE__ */ (0, J.jsx)("span", { children: a("settings.privateContactsDescription") })] }), /* @__PURE__ */ (0, J.jsx)(u_, { value: `${vt.filter((e) => St("allowed_user_ids", String(e.id))).length}/${vt.length}` })]
											}), /* @__PURE__ */ (0, J.jsx)("div", {
												className: "access-list",
												children: vt.length ? vt.map((e) => {
													let t = String(e.id || ""), n = String(e.name || dt(t) || a("settings.pendingAccess"));
													return /* @__PURE__ */ (0, J.jsxs)("label", {
														className: "access-list-row",
														children: [/* @__PURE__ */ (0, J.jsxs)("span", {
															className: "access-list-main",
															...
															type: "checkbox",
															checked: St("allowed_user_ids", t),
															onChange: (e) => Ct("allowed_user_ids", t, e.target.checked),
									...
									$e && /* @__PURE__ */ (0, J.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, J.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, J.jsx)("span", { children: a("settings.identityRoles") }), /* @__PURE__ */ (0, J.jsx)("code", { children: ft($e) })]
											}),
											/* @__PURE__ */ (0, J.jsxs)("label", { children: [/* @__PURE__ */ (0, J.jsx)("input", {
												type: "checkbox",
												checked: St("allowed_user_ids", $e),
												onChange: (e) => Ct("allowed_user_ids", $e, e.target.checked)
											}), a("settings.canTalk")] }),
											/* @__PURE__ */ (0, J.jsxs)("label", { children: [/* @__PURE__ */ (0, J.jsx)("input", {
												type: "checkbox",
												checked: St("mutation_allowed_user_ids", $e),
												onChange: (e) => Ct("mutation_allowed_user_ids", $e, e.target.checked)
											}), a("settings.canMutate")] }),
											/* @__PURE__ */ (0, J.jsxs)("label", { children: [/* @__PURE__ */ (0, J.jsx)("input", {
												type: "checkbox",
												checked: St("admin_user_ids", $e),
												onChange: (e) => Ct("admin_user_ids", $e, e.target.checked)
											}), a("settings.canAdmin")] })
										]
									}),
									wt.length > 0 && /* @__PURE__ */ (0, J.jsxs)("div", {
										className: "access-summary",
										children: [/* @__PURE__ */ (0, J.jsxs)("div", {
											className: "access-identity-heading",
											children: [/* @__PURE__ */ (0, J.jsx)("span", { children: a("settings.accessSummary") }), /* @__PURE__ */ (0, J.jsx)("small", { children: a("settings.identityCount", { count: wt.reduce((e, t) => e + t.ids.length, 0) }) })]
										}), wt.map((e) => /* @__PURE__ */ (0, J.jsxs)("button", {
											type: "button",
											...
											children: [
												...
												/* @__PURE__ */ (0, J.jsxs)("em", { children: [
													[
														...
														"admin_user_ids"
													].filter((t) => e.ids.some((e) => St(t, e))).length,
													" ",
							...
							children: [
									...
									children: /* @__PURE__ */ (0, J.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, J.jsx)($, {
											...
											children: /* @__PURE__ */ (0, J.jsx)("input", {
												...
												onChange: (t) => Et(e.id, { app_id: t.target.value })
											})
										}), /* @__PURE__ */ (0, J.jsx)($, {
											...
											children: /* @__PURE__ */ (0, J.jsx)("input", {
												...
												onChange: (t) => Et(e.id, { app_secret: t.target.value }),
								...
								/* @__PURE__ */ (0, J.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, J.jsx)(Av, {
										...
										onChange: (t) => Et(e.id, { conversation_enabled: t })
									})
								})
							]
						}, e.id)),
							...
							children: [/* @__PURE__ */ (0, J.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, J.jsx)($, {
										...
										help: rt.base_app_token_configured ? `Configured (${rt.base_app_token_masked || "set"}). Leave blank to keep. Env: ${rt.base_app_token_env || "FEISHU_MBPASS_QA_SHEET_TOKEN"}` : `Stored in ~/.lumon/.env.local as ${rt.base_app_token_env || "FEISHU_MBPASS_QA_SHEET_TOKEN"}`,
										children: /* @__PURE__ */ (0, J.jsx)("input", {
											value: at,
											placeholder: rt.base_app_token_configured ? "Leave blank to keep current token" : "https://…/sheets/TOKEN or TOKEN",
											onChange: (e) => {
												ot(e.target.value), L();
											},
											autoComplete: "off"
							...
							children: [/* @__PURE__ */ (0, J.jsxs)("div", {
								...
								children: /* @__PURE__ */ (0, J.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, J.jsxs)("div", { children: [/* @__PURE__ */ (0, J.jsx)("span", { children: a("settings.runtimeModel") }), /* @__PURE__ */ (0, J.jsx)("code", { children: Q(l.model, ce) })] }),
										l.provider === "codex" && /* @__PURE__ */ (0, J.jsxs)("div", { children: [/* @__PURE__ */ (0, J.jsx)("span", { children: a("settings.reasoningEffort") }), /* @__PURE__ */ (0, J.jsx)("code", { children: Q(l.reasoning_effort, me || "xhigh") })] }),
										...
										children: [
											/* @__PURE__ */ (0, J.jsx)($, {
												...
												children: /* @__PURE__ */ (0, J.jsxs)("select", {
													value: Ne,
													onChange: (e) => {
														Pe(e.target.value), Me(e.target.value !== "none"), L();
													},
													children: [
														/* @__PURE__ */ (0, J.jsx)("option", {
															value: "none",
											...
											Ne === "jenkins" && /* @__PURE__ */ (0, J.jsxs)(J.Fragment, { children: [/* @__PURE__ */ (0, J.jsx)($, {
												...
												children: [
													/* @__PURE__ */ (0, J.jsxs)("div", { children: [/* @__PURE__ */ (0, J.jsx)("span", {
														...
														className: `integration-status${Mt ? " is-configured" : ""}`,
														children: a(Mt ? "settings.configured" : "settings.notConfigured")
													})] }),
													/* @__PURE__ */ (0, J.jsx)("code", { children: "JENKINS_URL + JENKINS_AUTH" }),
													/* @__PURE__ */ (0, J.jsx)("p", { children: a("settings.jenkinsCredentials") })
												]
											})] }),
											Ne === "github_actions" && /* @__PURE__ */ (0, J.jsxs)(J.Fragment, { children: [
												/* @__PURE__ */ (0, J.jsx)($, {
						...
						children: /* @__PURE__ */ (0, J.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, J.jsxs)("div", {
								...
								children: /* @__PURE__ */ (0, J.jsx)("div", {
									...
									children: At.length ? At.map((e) => {
										let t = Se[e] ?? be[e] ?? "", n = jt[e] === "lumon_local" ? a("settings.storedLumon") : a("settings.storedWorkspace");
										return /* @__PURE__ */ (0, J.jsxs)("div", {
											...
											children: [
												...
												/* @__PURE__ */ (0, J.jsx)("input", {
													type: be[e] || Se[e] !== void 0 ? "text" : "password",
													value: t,
												...
												/* @__PURE__ */ (0, J.jsxs)("div", { children: [/* @__PURE__ */ (0, J.jsx)(N_, {
													...
													onClick: () => void Ot(e),
													children: be[e] ? /* @__PURE__ */ (0, J.jsx)(Jh, { size: 15 }) : /* @__PURE__ */ (0, J.jsx)(Yh, { size: 15 })
												}), /* @__PURE__ */ (0, J.jsx)(N_, {
			...
			/* @__PURE__ */ (0, J.jsxs)("footer", {
				...
				children: [/* @__PURE__ */ (0, J.jsx)("span", {
					className: lt ? "settings-save-status unsaved" : "settings-save-status",
					children: a(st ? "common.saving" : lt ? "settings.unsavedChanges" : "settings.allSaved")
				}), /* @__PURE__ */ (0, J.jsxs)("button", {
					className: `button primary${st ? " is-busy" : ""}`,
					disabled: !lt || st,
					onClick: () => void Gt(),
					children: [st ? /* @__PURE__ */ (0, J.jsx)(ag, {
						size: 15,
						className: "spin"
					}) : /* @__PURE__ */ (0, J.jsx)(ug, { size: 15 }), a(st ? "common.saving" : "action.saveChanges")]
				})]
			})
		]
	});
