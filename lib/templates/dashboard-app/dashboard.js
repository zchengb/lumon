...
var f_ = (0, F.memo)(function({ chart: e }) {
...
function D_({ value: e, onChange: t }) {
	let { t: n } = Z(), { frontmatter: r, body: i } = __(e), a = (0, F.useRef)(null), o = (0, F.useRef)(!1), s = (0, F.useRef)(!1), c = (0, F.useRef)(i), l = (0, F.useRef)(S_()), [u, d] = (0, F.useState)(null), [f, p] = (0, F.useState)(!1);
	c.current = i;
	let m = (e) => t(v_(r, e)), h = () => {
		let e = a.current;
		if (!e) return;
	...
	let i = {
		...
		return /* @__PURE__ */ (0, J.jsxs)("button", {
			...
			children: [/* @__PURE__ */ (0, J.jsx)(qg, {
				...
				/* @__PURE__ */ (0, J.jsx)("strong", { children: i.name }),
				/* @__PURE__ */ (0, J.jsx)("small", { children: i.title })
			] })]
		});
	}, d = (e) => /* @__PURE__ */ (0, J.jsxs)("div", {
		className: "agent-team-facts",
		children: [/* @__PURE__ */ (0, J.jsxs)("span", { children: [/* @__PURE__ */ (0, J.jsx)("b", { children: n("label.input") }), e.input] }), /* @__PURE__ */ (0, J.jsxs)("span", { children: [/* @__PURE__ */ (0, J.jsx)("b", { children: n("label.output") }), e.output] })]
	});
	return /* @__PURE__ */ (0, J.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, J.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, J.jsx)("span", {
					...
					children: /* @__PURE__ */ (0, J.jsx)(yg, { size: 17 })
				}), /* @__PURE__ */ (0, J.jsxs)("span", { children: [
					/* @__PURE__ */ (0, J.jsx)("span", {
						className: "overview-kicker",
			...
			/* @__PURE__ */ (0, J.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, J.jsx)("span", {
					className: "agent-team-layer-label",
					children: n("label.managerLayer")
			...
			/* @__PURE__ */ (0, J.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, J.jsxs)("div", {
					className: "agent-team-capabilities-heading",
					children: [/* @__PURE__ */ (0, J.jsx)("span", {
						className: "agent-team-layer-label",
						children: n("label.capabilityOwners")
					}), /* @__PURE__ */ (0, J.jsx)("span", {
						className: "muted",
						children: n("label.businessReadyCapabilities")
					})]
				}), /* @__PURE__ */ (0, J.jsx)("div", {
					...
					children: t.map((e) => {
						...
						return /* @__PURE__ */ (0, J.jsxs)("article", {
							...
							children: [
								/* @__PURE__ */ (0, J.jsxs)("div", {
									className: "agent-team-card-heading",
									children: [u(t, i), /* @__PURE__ */ (0, J.jsxs)("span", {
										className: "agent-team-statuses",
										children: [/* @__PURE__ */ (0, J.jsx)(a_, { value: o(t) }), /* @__PURE__ */ (0, J.jsx)(a_, { value: e.status })]
									})]
								}),
								/* @__PURE__ */ (0, J.jsx)("p", {
									className: "agent-team-mission",
...
function L_({ data: e, project: t, onNavigate: n }) {
	let { t: r } = Z(), i = e.activity?.items || [], [a, o] = (0, F.useState)("all"), [s, c] = (0, F.useState)(0), l = i.filter((e) => a === "all" || String(e.agent_id || "") === a), u = Array.from(new Set(i.map((e) => String(e.agent_id || "")).filter(Boolean))), d = i.filter((e) => /completed|success|delegated/i.test(String(e.status || ""))).length, f = i.filter((e) => /failed|blocked|denied/i.test(String(e.status || ""))).length, p = Number(e.activity?.total ?? i.length), m = i.map((e) => Number(e.latency_ms)).filter((e) => Number.isFinite(e) && e >= 0), h = m.length ? t_(Math.round(m.reduce((e, t) => e + t, 0) / m.length)) : "—", g = Math.max(1, Math.ceil(l.length / 10)), _ = l.slice(s * 10, (s + 1) * 10);
	(0, F.useEffect)(() => {
		c(0);
	}, [a]), (0, F.useEffect)(() => {
		c((e) => Math.min(e, g - 1));
		...
		/* @__PURE__ */ (0, J.jsxs)(k_, {
			...
			children: [
				...
				le && /* @__PURE__ */ (0, J.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, J.jsxs)("div", { children: [/* @__PURE__ */ (0, J.jsx)("span", { children: i("label.deployment") }), /* @__PURE__ */ (0, J.jsx)("strong", { children: /* @__PURE__ */ (0, J.jsx)(a_, { value: le.status || "queued" }) })] }),
						...
						/* @__PURE__ */ (0, J.jsxs)("div", { children: [/* @__PURE__ */ (0, J.jsx)("span", { children: i("label.lastChecked") }), /* @__PURE__ */ (0, J.jsx)("strong", { children: $g(le.last_checked_at) })] }),
...
function rv({ project: e, notify: t, onDirtyChange: n }) {
	let { t: r } = Z(), i = new URLSearchParams(window.location.search).get("story") || "", [a, o] = (0, F.useState)([]), [s, c] = (0, F.useState)(i), [l, u] = (0, F.useState)(""), [d, f] = (0, F.useState)(""), [p, m] = (0, F.useState)(""), [h, g] = (0, F.useState)(""), [_, v] = (0, F.useState)(""), [y, b] = (0, F.useState)(""), [x, S] = (0, F.useState)(""), [C, w] = (0, F.useState)({
		story: "",
		plan: ""
	}), [T, E] = (0, F.useState)("story"), [ee, D] = (0, F.useState)(!0), [O, te] = (0, F.useState)(!1), [k, A] = (0, F.useState)(!1), [j, M] = (0, F.useState)(""), [N, ne] = (0, F.useState)(!1), [re, ie] = (0, F.useState)(!1), [ae, P] = (0, F.useState)(0), [oe, se] = (0, F.useState)(""), [ce, le] = (0, F.useState)(!1), [ue, de] = (0, F.useState)(""), fe = y !== C.story || x !== C.plan, pe = N_(a.filter(P_)), me = pe.length > 0;
	(0, F.useEffect)(() => {
		n(fe);
	}, [fe, n]), (0, F.useEffect)(() => {
		let e = (e) => {
				...
				children: [
					...
					/* @__PURE__ */ (0, J.jsxs)("div", {
						...
						children: [
							...
							!ee && !I.length ? /* @__PURE__ */ (0, J.jsx)(W_, { label: a.length ? r("common.noStoriesFilter") : r("common.noStories") }) : null,
							I.map((e) => {
				...
				children: [
					...
					/* @__PURE__ */ (0, J.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, J.jsxs)("div", {
							...
							}), te.length === 0 && /* @__PURE__ */ (0, J.jsx)(W_, { label: n("common.noData") })]
						})
					})
				]
			}),
											...
											/* @__PURE__ */ (0, J.jsxs)("div", {
												...
												children: [
													...
													/* @__PURE__ */ (0, J.jsx)(sv, {
														...
														value: /* @__PURE__ */ (0, J.jsx)(a_, { value: j.git_status || "unknown" })
													}),
													/* @__PURE__ */ (0, J.jsx)(sv, {
														label: n("common.branchSync"),
														value: /* @__PURE__ */ (0, J.jsx)(a_, { value: j.sync_status || "unknown" })
													})
												]
											}),
											/* @__PURE__ */ (0, J.jsx)("div", {
...
function Cv({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	let { t: a } = Z(), o = e.interactive?.workspace || {}, s = e.interactive?.schedules || {}, c = e.interactive?.agents || {}, [l, u] = (0, F.useState)(String(o.scan_window_days || 7)), [d, f] = (0, F.useState)(String(s.scan?.cron || "0 12 * * 1-5")), [p, m] = (0, F.useState)(!!s.scan), [h, g] = (0, F.useState)(String(Math.round((s.delivery?.interval_seconds || 300) / 60))), [_, v] = (0, F.useState)(Array.isArray(s.delivery?.jira_statuses) ? s.delivery.jira_statuses.map(String) : String(s.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean)), [y, b] = (0, F.useState)(String(s.delivery?.in_dev_status || "")), [x, S] = (0, F.useState)(String(s.delivery?.dev_done_status || "")), [C, w] = (0, F.useState)(String(s.delivery?.blocked_status || "Block")), [T, E] = (0, F.useState)(!!s.delivery?.enabled), [ee, D] = (0, F.useState)(String(Math.round((s.patch?.interval_seconds || 300) / 60))), [O, te] = (0, F.useState)(Array.isArray(s.patch?.jira_statuses) ? s.patch.jira_statuses.map(String) : ["To Do"]), [k, A] = (0, F.useState)(String(s.patch?.in_progress_status || "In Progress")), [j, M] = (0, F.useState)(String(s.patch?.done_status || "Done")), [N, ne] = (0, F.useState)(String(s.patch?.blocked_status || "Block")), [re, ie] = (0, F.useState)(!!s.patch?.enabled), [ae, P] = (0, F.useState)(Zg(o.models?.scan)), [oe, se] = (0, F.useState)(Zg(o.models?.delivery)), [ce, le] = (0, F.useState)(Zg(o.models?.patch)), [ue, de] = (0, F.useState)([]), [fe, pe] = (0, F.useState)({}), [me, he] = (0, F.useState)({}), [ge, _e] = (0, F.useState)(String(o.publish?.scan || "pr")), [ve, ye] = (0, F.useState)(String(o.publish?.delivery || "pr")), [be, xe] = (0, F.useState)(String(o.publish?.patch || "pr")), [Se, I] = (0, F.useState)(o.feishu_notifications_enabled !== !1), [Ce, we] = (0, F.useState)(!!o.deployment_tracking?.enabled), [Te, Ee] = (0, F.useState)(String(o.deployment_tracking?.provider || "none")), [De, Oe] = (0, F.useState)(String(o.deployment_tracking?.poll_interval_seconds || 30)), [ke, Ae] = (0, F.useState)(String(o.deployment_tracking?.timeout_seconds || 3600)), [je, Me] = (0, F.useState)(String(o.deployment_tracking?.failure_policy || "dispatch_agent")), [Ne, Pe] = (0, F.useState)(String(o.deployment_tracking?.jenkins?.job || "")), [Fe, Ie] = (0, F.useState)(String(o.deployment_tracking?.jenkins?.trigger_mode || "observe")), [Le, Re] = (0, F.useState)(String(o.deployment_tracking?.github_actions?.repository || "")), [ze, Be] = (0, F.useState)(String(o.deployment_tracking?.github_actions?.workflow || "")), [Ve, He] = (0, F.useState)(!!c.enabled), [Ue, We] = (0, F.useState)(Array.isArray(c.agents) ? c.agents.map((e) => ({ ...e })) : []), [Ge, Ke] = (0, F.useState)({
	...
	(0, F.useEffect)(() => {
		i_("/api/delivery/status-options", t).then((e) => de(Array.isArray(e.options) ? e.options.map(String) : [])).catch(() => de([]));
	}, [t]), (0, F.useEffect)(() => {
		let e = !1;
		...
		we(!!e.enabled), Ee(String(e.provider || "none")), Oe(String(e.poll_interval_seconds || 30)), Ae(String(e.timeout_seconds || 3600)), Me(String(e.failure_policy || "dispatch_agent")), Pe(String(e.jenkins?.job || "")), Ie(String(e.jenkins?.trigger_mode || "observe")), Re(String(e.github_actions?.repository || "")), Be(String(e.github_actions?.workflow || ""));
	...
	let Ct = async (e) => {
	...
	}, Et = o.configured_integrations || [], Dt = Array.from(new Set([
		"To Do",
		"Backlog",
		"In Progress",
		"Done",
		...
		j,
		N
	].filter(Boolean))), Ot = Array.isArray(s.delivery?.jira_statuses) ? s.delivery.jira_statuses.map(String) : String(s.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean), kt = Array.isArray(s.patch?.jira_statuses) ? s.patch.jira_statuses.map(String) : ["To Do"], At = (e, t) => e.length === t.length && e.every((e, n) => e === t[n]), jt = p !== !!s.scan || p && d !== String(s.scan?.cron || "0 12 * * 1-5"), Mt = T !== !!s.delivery?.enabled || T && (h !== String(Math.round((s.delivery?.interval_seconds || 300) / 60)) || !At(_, Ot) || y !== String(s.delivery?.in_dev_status || "") || x !== String(s.delivery?.dev_done_status || "") || C !== String(s.delivery?.blocked_status || "Block")), Nt = re !== !!s.patch?.enabled || re && (ee !== String(Math.round((s.patch?.interval_seconds || 300) / 60)) || !At(O, kt) || k !== String(s.patch?.in_progress_status || "In Progress") || j !== String(s.patch?.done_status || "Done") || N !== String(s.patch?.blocked_status || "Block")), Pt = ge !== String(o.publish?.scan || "pr") || ve !== String(o.publish?.delivery || "pr") || be !== String(o.publish?.patch || "pr"), Ft = {
		enabled: Ce,
		provider: Te,
		poll_interval_seconds: Number(De),
		timeout_seconds: Number(ke),
		failure_policy: je,
		jenkins: {
			job: Ne,
			trigger_mode: Fe
	...
	}, It = o.deployment_tracking || {}, Lt = JSON.stringify(Ft) !== JSON.stringify({
		enabled: !!It.enabled,
		provider: String(It.provider || "none"),
		poll_interval_seconds: Number(It.poll_interval_seconds || 30),
		timeout_seconds: Number(It.timeout_seconds || 3600),
		failure_policy: String(It.failure_policy || "dispatch_agent"),
		jenkins: {
			job: String(It.jenkins?.job || ""),
			trigger_mode: String(It.jenkins?.trigger_mode || "observe")
		},
		github_actions: {
			repository: String(It.github_actions?.repository || ""),
			workflow: String(It.github_actions?.workflow || "")
		}
	}), Rt = Ve !== $e.enabled || JSON.stringify(Ue) !== $e.agents || JSON.stringify(Ge) !== $e.access || JSON.stringify({
		...
		if (!at) {
			...
			try {
				...
				for (let e of Ue) if (!String(e.model || "").trim()) throw Error(`${e.display_name || e.id} needs a Cursor model.`);
				...
				}), ...Object.entries(me).map(([e, n]) => () => i_("/api/integration", t, {
					method: "POST",
					json: {
						key: e,
						value: n
				...
				})), Pt && e.push(() => i_("/api/publish-policy", t, {
					method: "POST",
					json: {
						scan_mode: ge,
						delivery_mode: ve,
				...
				})), Lt && e.push(() => i_("/api/deployment-config", t, {
					method: "POST",
					json: Ft
				})), Rt && e.push(async () => {
				...
				he({}), ct(!1), r(!1), n("Settings saved", "success"), i();
			} catch (e) {
		...
		T,
		re
	].filter(Boolean).length, Vt = Ue.filter((e) => e.conversation_enabled).length;
	return /* @__PURE__ */ (0, J.jsxs)("div", {
			...
			/* @__PURE__ */ (0, J.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, J.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, J.jsxs)("strong", { children: [Bt, "/3"] }),
										...
										children: [
											...
											/* @__PURE__ */ (0, J.jsx)($, {
												...
												children: /* @__PURE__ */ (0, J.jsx)("select", {
													...
													children: Dt.map((e) => /* @__PURE__ */ (0, J.jsx)("option", {
														value: e,
														children: e
													}, e))
												})
											...
											/* @__PURE__ */ (0, J.jsx)($, {
												...
												children: /* @__PURE__ */ (0, J.jsx)("select", {
													...
													children: Array.from(/* @__PURE__ */ new Set([...Dt, "Block"])).map((e) => /* @__PURE__ */ (0, J.jsx)("option", {
														value: e,
														children: e
													}, e))
												})
										...
										children: [
											...
											/* @__PURE__ */ (0, J.jsx)($, {
												...
												children: /* @__PURE__ */ (0, J.jsxs)("select", {
													...
													onChange: (t) => St(e.id, { conversation_enabled: t.target.value === "on" }),
													children: [/* @__PURE__ */ (0, J.jsx)("option", {
														value: "on",
							...
							children: [
								/* @__PURE__ */ (0, J.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, J.jsx)("p", {
											className: "schedule-note",
											children: a("settings.deploymentTrackingNote")
										})
									]
								}),
								/* @__PURE__ */ (0, J.jsx)("div", {
										...
										children: [
											/* @__PURE__ */ (0, J.jsx)($, {
												...
												children: /* @__PURE__ */ (0, J.jsxs)("select", {
													value: Te,
													onChange: (e) => {
														Ee(e.target.value), we(e.target.value !== "none"), L();
													},
													children: [
														/* @__PURE__ */ (0, J.jsx)("option", {
															value: "none",
											...
											/* @__PURE__ */ (0, J.jsx)($, {
												label: a("settings.failurePolicy"),
												children: /* @__PURE__ */ (0, J.jsxs)("select", {
													value: je,
													onChange: (e) => {
														Me(e.target.value), L();
													...
													children: [/* @__PURE__ */ (0, J.jsx)("option", {
														value: "notify",
														children: a("settings.notifyOnly")
													}), /* @__PURE__ */ (0, J.jsx)("option", {
														value: "dispatch_agent",
														children: a("settings.dispatchAgent")
													})]
												})
											}),
											/* @__PURE__ */ (0, J.jsx)($, {
											...
											Te === "jenkins" && /* @__PURE__ */ (0, J.jsxs)(J.Fragment, { children: [/* @__PURE__ */ (0, J.jsx)($, {
												label: a("settings.jenkinsJob"),
												children: /* @__PURE__ */ (0, J.jsx)("input", {
													value: Ne,
												...
												children: /* @__PURE__ */ (0, J.jsxs)("select", {
													...
													children: [/* @__PURE__ */ (0, J.jsx)("option", {
														value: "observe",
														children: a("settings.observeRun")
													}), /* @__PURE__ */ (0, J.jsx)("option", {
														value: "cli",
														children: a("settings.triggerWithCli")
													})]
												})
											})] }),
											Te === "github_actions" && /* @__PURE__ */ (0, J.jsxs)(J.Fragment, { children: [/* @__PURE__ */ (0, J.jsx)($, {
...
(0, _e.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, J.jsx)(zg, { children: /* @__PURE__ */ (0, J.jsx)(A_, {}) }));
//#endregion
