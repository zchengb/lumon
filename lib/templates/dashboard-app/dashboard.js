...
function Pg(e, t = "cursor-grok-4.5-medium") {
...
function Vg({ value: e }) {
	return /* @__PURE__ */ (0, Y.jsx)("span", {
		className: `badge ${Rg(e)}`,
		children: zg(e)
	});
}
function Hg({ business: e, technical: t, compact: n = !1 }) {
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("span", {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("em", { children: "Business" }), /* @__PURE__ */ (0, Y.jsx)(Vg, { value: e || "draft" })]
		}), /* @__PURE__ */ (0, Y.jsxs)("span", {
			className: "observatory-meta-item",
			children: [/* @__PURE__ */ (0, Y.jsx)("em", { children: "Technical" }), /* @__PURE__ */ (0, Y.jsx)(Vg, { value: t || "draft" })]
		})]
	});
}
function Ug(e) {
...
function Wg({ date: e, assignee: t }) {
	let n = Ug(e), r = String(t || "").trim();
...
function Gg({ business: e, technical: t }) {
	let n = Rg(e || "draft"), r = Rg(t || "draft"), i = (e) => e === "success" ? /* @__PURE__ */ (0, Y.jsx)("i", { className: "observatory-status-dot" }) : /* @__PURE__ */ (0, Y.jsx)(Hh, { size: 11 });
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
...
function Kg({ label: e, onClose: t, children: n }) {
...
var Jg = (0, F.memo)(function({ chart: e }) {
...
function Xg({ className: e, children: t }) {
	let n = String(t).replace(/\n$/, ""), [r, i] = (0, F.useState)(!1);
	return /language-mermaid/.test(e || "") ? /* @__PURE__ */ (0, Y.jsx)(Jg, { chart: n }) : !n.includes("\n") && !e ? /* @__PURE__ */ (0, Y.jsx)("code", {
		className: e,
		children: t
...
var Zg = {
	...
	img({ src: e, alt: t }) {
		return /* @__PURE__ */ (0, Y.jsx)(Yg, {
			src: e,
			alt: t
		});
	},
	code({ className: e, children: t }) {
		return /* @__PURE__ */ (0, Y.jsx)(Xg, {
			className: e,
			children: t
		});
	}
};
function Qg({ content: e }) {
...
var t_ = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"14\" height=\"14\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect width=\"14\" height=\"14\" x=\"8\" y=\"8\" rx=\"2\" ry=\"2\"/><path d=\"M4 16V4a2 2 0 0 1 2-2h12\"/></svg>";
function n_(e) {
	for (let t of Array.from(e.querySelectorAll("pre"))) {
		...
		o.type = "button", o.className = "md-code-copy", o.title = "Copy code", o.setAttribute("aria-label", "Copy code"), o.innerHTML = t_, o.onclick = (n) => {
...
function l_({ value: e, onChange: t }) {
	let { frontmatter: n, body: r } = $g(e), i = (0, F.useRef)(null), a = (0, F.useRef)(!1), o = (0, F.useRef)(!1), s = (0, F.useRef)(r), c = (0, F.useRef)(i_()), [l, u] = (0, F.useState)(null), [d, f] = (0, F.useState)(!1);
	s.current = r;
	let p = (e) => t(e_(n, e)), m = () => {
		let e = i.current;
		if (!e) return;
		let t = c.current.turndown(e);
		o_(o.current, t, s.current) && p(t);
	}, h = (e) => {
		...
		let t = i.current;
		if (!t) return;
		o.current = !1, t.innerHTML = r_(e), n_(t), h(t);
				...
				children: [
					...
					/* @__PURE__ */ (0, Y.jsx)("button", {
						...
						onClick: () => {
							let e = i.current;
							e?.focus();
							let t = s_(e), n = t?.getAttribute("href") || "https://", r = window.prompt(t ? "Edit link URL" : "Link URL", n);
							if (r === null) return;
							let a = r.trim();
							if (t) {
								if (!a) {
			...
			/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, Y.jsx)("button", {
					...
					onClick: (e) => {
						...
						if (!(n instanceof HTMLAnchorElement) || !i.current?.contains(n) || !c_(e)) return;
...
function u_({ label: e, children: t, onClick: n, danger: r = !1, disabled: i = !1, className: a = "" }) {
...
function d_({ title: e, action: t, children: n, className: r = "" }) {
				...
				children: [/* @__PURE__ */ (0, Y.jsxs)("header", {
					...
					children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsx)("span", {
							...
							children: m ? `Updated ${Ig(m.toISOString())}` : "Syncing…"
					...
					children: [
						...
						n && i === "overview" && /* @__PURE__ */ (0, Y.jsx)(__, {
							data: n,
							project: e,
							onNavigate: D
						}),
						n && i === "scan" && /* @__PURE__ */ (0, Y.jsx)(v_, {
							data: n,
							project: e,
							notify: w,
							reload: T
						}),
						n && i === "delivery" && /* @__PURE__ */ (0, Y.jsx)(O_, {
							data: n,
							project: e,
							notify: w,
							reload: T
						}),
						n && i === "patch" && /* @__PURE__ */ (0, Y.jsx)(k_, {
							data: n,
							project: e,
							notify: w,
							reload: T
						}),
						n && i === "observatory" && /* @__PURE__ */ (0, Y.jsx)(F_, {
							project: e,
							notify: w,
							onDirtyChange: y
						}),
						n && i === "repositories" && /* @__PURE__ */ (0, Y.jsx)($_, {
							data: n,
							interact: O
						}),
						n && i === "prompts" && /* @__PURE__ */ (0, Y.jsx)(q_, {
							data: n,
							project: e,
							interact: O,
							notify: w
						}),
						n && i === "settings" && /* @__PURE__ */ (0, Y.jsx)(tv, {
							data: n,
							project: e,
							notify: w,
							onDirtyChange: _,
...
function p_({ conflict: e, project: t, notify: n, onClose: r, onResolved: i }) {
	let [a, o] = (0, F.useState)(!1), [s, c] = (0, F.useState)(""), l = async () => {
		o(!0), c("");
		try {
			await Bg("/api/git-sync/force", t, {
				method: "POST",
				json: {}
...
function __({ data: e, project: t, onNavigate: n }) {
	let r = e.interactive?.agents || {}, i = r.agents || [], a = r.pending_questions || [], o = [
		{
			id: "scan",
			name: "Auto Scan",
			owner: "Dylan",
			status: e.runs?.[0]?.status || "not started",
			detail: "Findings, risk triage, and review-ready evidence."
		},
		{
			id: "delivery",
			name: "Auto Delivery",
			owner: "Mark",
			status: e.delivery?.current?.delivery_status || "not started",
			detail: "Approved stories, verification, and pull request delivery."
		},
		{
			id: "patch",
			name: "Auto Patch",
			owner: "Irving",
			status: e.patch?.current?.patch_status || "not started",
			detail: "Jira Task/Bug capture, focused fixes, and safe handoff."
		}
			...
			/* @__PURE__ */ (0, Y.jsx)(d_, {
				...
				children: /* @__PURE__ */ (0, Y.jsx)("div", {
					...
					children: i.length ? i.map((e) => {
						let t = s(e), r = e.workflow === "auto_scan" ? "scan" : e.workflow === "auto_delivery" ? "delivery" : e.workflow === "auto_patch" ? "patch" : "";
							...
							children: [
								/* @__PURE__ */ (0, Y.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, Y.jsxs)("div", { children: [
										...
										/* @__PURE__ */ (0, Y.jsx)("p", { children: e.title })
									] }), /* @__PURE__ */ (0, Y.jsx)(Vg, { value: u(t) })]
								}),
								/* @__PURE__ */ (0, Y.jsxs)("div", {
									className: "agent-card-facts",
									children: [
										/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)("span", { children: "Role" }), /* @__PURE__ */ (0, Y.jsx)("strong", { children: e.role })] }),
										/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)("span", { children: "Workflow" }), /* @__PURE__ */ (0, Y.jsx)("strong", { children: e.workflow })] }),
										/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)("span", { children: "Runner" }), /* @__PURE__ */ (0, Y.jsx)("strong", { children: Q(e.security?.sandbox, "enabled") })] })
									]
								}),
								/* @__PURE__ */ (0, Y.jsxs)("div", {
									className: "agent-card-footer",
									children: [/* @__PURE__ */ (0, Y.jsx)("span", { children: t === "ready" ? "Conversation and actions available" : t === "paused" ? "Conversation is paused in Settings" : "Credentials are required" }), r ? /* @__PURE__ */ (0, Y.jsxs)("button", {
										className: "text-button",
										onClick: () => n(r),
										children: ["Open workflow ", /* @__PURE__ */ (0, Y.jsx)(zh, { size: 13 })]
									}) : /* @__PURE__ */ (0, Y.jsx)("span", {
					...
					}) : /* @__PURE__ */ (0, Y.jsx)(S_, { label: "No Agent roles available yet." })
				})
			}),
			/* @__PURE__ */ (0, Y.jsx)(d_, {
						...
						children: [
							/* @__PURE__ */ (0, Y.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)("span", {
									className: "overview-kicker",
									children: e.owner
								}), /* @__PURE__ */ (0, Y.jsx)("h4", { children: e.name })] }), /* @__PURE__ */ (0, Y.jsx)(Vg, { value: e.status })]
							}),
							/* @__PURE__ */ (0, Y.jsx)("p", { children: e.detail }),
							/* @__PURE__ */ (0, Y.jsxs)("button", {
								className: "button secondary",
								onClick: () => n(e.id),
								children: [
				...
				children: a.length ? /* @__PURE__ */ (0, Y.jsx)("div", {
					...
					children: a.map((e, t) => /* @__PURE__ */ (0, Y.jsxs)("article", {
						...
						children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							}), /* @__PURE__ */ (0, Y.jsx)("strong", { children: Q(e.action, "Clarification") })] }), /* @__PURE__ */ (0, Y.jsx)("time", { children: Ig(e.created_at) })]
...
function v_({ data: e, project: t, notify: n, reload: r }) {
	...
	return /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [
		...
		/* @__PURE__ */ (0, Y.jsxs)(d_, {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("table", { children: [/* @__PURE__ */ (0, Y.jsx)("thead", { children: /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
					...
					/* @__PURE__ */ (0, Y.jsx)("td", { children: Ig(e.started_at || e.finished_at) }),
					/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(Vg, { value: e.status }) }),
					/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(C_, { run: e }) }),
			...
			}), o.length > 10 && /* @__PURE__ */ (0, Y.jsx)(w_, {
				page: d,
		...
		/* @__PURE__ */ (0, Y.jsxs)(d_, {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				id: "tracked-findings",
				className: "findings",
				children: b.length ? b.map((e) => /* @__PURE__ */ (0, Y.jsx)(T_, {
					issue: e,
					onIgnore: () => c(e)
				}, e.id)) : /* @__PURE__ */ (0, Y.jsx)(S_, { label: "No findings match this status." })
			})]
		}),
		s && /* @__PURE__ */ (0, Y.jsx)(D_, {
			onClose: () => c(null),
			onConfirm: (e) => {
				y_(t, n, r, s.id, e), c(null);
			}
		}),
		p > 0 && /* @__PURE__ */ (0, Y.jsx)(b_, {
			project: t,
			step: p === 1 ? 1 : 2,
			busy: h,
			error: _,
...
async function y_(e, t, n, r, i) {
	try {
		await Bg("/api/issue/ignore", e, {
			method: "POST",
			json: {
				issue_id: r,
				reason: i
...
function b_({ project: e, step: t, busy: n, error: r, onClose: i, onContinue: a, onConfirm: o }) {
	let s = t === 1;
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
...
function x_({ label: e, value: t, onClick: n }) {
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
...
function w_({ page: e, pageCount: t, onChange: n }) {
...
function T_({ issue: e, onIgnore: t }) {
	...
	return /* @__PURE__ */ (0, Y.jsxs)("article", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsx)("h4", { children: Q(e.title, "Untitled finding") }), /* @__PURE__ */ (0, Y.jsx)(Vg, { value: i })]
					}),
					/* @__PURE__ */ (0, Y.jsxs)("p", {
			...
			children: [
				...
				/* @__PURE__ */ (0, Y.jsx)(E_, {
					label: "Resolved at",
					value: Ig(e.resolved_at)
				}),
				/* @__PURE__ */ (0, Y.jsx)(E_, {
					label: "Last verification",
					value: Ig(e.last_verified_at)
				}),
				/* @__PURE__ */ (0, Y.jsx)(E_, {
					label: "Impact",
					value: e.impact
...
function E_({ label: e, value: t, code: n = !1 }) {
	return /* @__PURE__ */ (0, Y.jsxs)("section", {
...
function D_({ onClose: e, onConfirm: t }) {
...
function O_({ data: e, project: t, notify: n, reload: r }) {
	let i = e.delivery || {}, a = i.current || {}, o = i.runs || [], s = a.stages || [], c = i.scheduler_activity || [], l = i.available_stories || [], [u, d] = (0, F.useState)(null), [f, p] = (0, F.useState)(null), [m, h] = (0, F.useState)(""), [g, _] = (0, F.useState)(""), [v, y] = (0, F.useState)(!1), [b, x] = (0, F.useState)(!1), [S, C] = (0, F.useState)(!1), [w, T] = (0, F.useState)(!1), [E, ee] = (0, F.useState)(""), [D, O] = (0, F.useState)(0), [k, A] = (0, F.useState)(""), [j, M] = (0, F.useState)(!1), [N, te] = (0, F.useState)(""), [ne, re] = (0, F.useState)(null), [ie, ae] = (0, F.useState)(""), [P, oe] = (0, F.useState)(Date.now()), se = /in_progress|running/i.test(String(a.delivery_status || "")), ce = h_(l, a), le = (0, F.useCallback)(async (e = a.run_id || "", n = !1) => {
		n || y(!0);
		try {
			let n = await Bg(`/api/delivery/log?run_id=${encodeURIComponent(e)}`, t);
	...
	let de = async (e, t = a.run_id || "") => {
		...
		x(!0), h(""), _(""), y(!0);
		try {
			let e = await Bg("/api/delivery/scheduler-log", t);
		...
		try {
			let n = await Bg(`/api/delivery/trace?run_id=${encodeURIComponent(e)}`, t);
			d({
				label: "Trace",
		...
		if (e) {
			ae(e), te("");
			try {
				await Bg("/api/delivery/history/delete", t, {
					method: "POST",
					json: { run_id: e }
			...
			children: [
				/* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, Y.jsx)(z_, {
							label: "Status",
							value: /* @__PURE__ */ (0, Y.jsx)(Vg, { value: a.delivery_status || "not started" })
						}),
						/* @__PURE__ */ (0, Y.jsx)(z_, {
							label: "Elapsed",
							value: Lg(a.started_at, a.finished_at || (se ? new Date(P).toISOString() : void 0))
						}),
						/* @__PURE__ */ (0, Y.jsx)(z_, {
							label: "Finished",
							value: se ? "Running" : Ig(a.finished_at)
						})
					]
				}),
			...
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("table", { children: [/* @__PURE__ */ (0, Y.jsx)("thead", { children: /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
					...
					return /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
						...
						/* @__PURE__ */ (0, Y.jsx)("td", { children: Ig(e.finished_at || e.started_at) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: r ? /* @__PURE__ */ (0, Y.jsx)("button", {
							...
							onClick: () => void de({
								...
								duration: Lg(e.started_at, e.finished_at),
								detail: n.map((e) => e.summary || e.label).filter(Boolean).join(" · ") || "Open the delivery log for details."
							}, e.run_id),
							children: /* @__PURE__ */ (0, Y.jsx)(Vg, { value: e.status })
						}) : /* @__PURE__ */ (0, Y.jsx)(Vg, { value: e.status }) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(B_, { items: e.pull_requests || [] }) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(V_, {
							checks: t,
							onClick: () => p(t)
						}) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: Lg(e.started_at, e.finished_at) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: e.agent_trace && /* @__PURE__ */ (0, Y.jsx)("button", {
							className: "text-button",
							onClick: () => void _e(e.run_id),
							children: "View trace"
						}) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(u_, {
					...
					colSpan: 8,
					children: /* @__PURE__ */ (0, Y.jsx)(S_, { label: "No delivery history yet." })
				}) }) })] })
			})
		}),
		/* @__PURE__ */ (0, Y.jsx)(d_, {
			...
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: c.length ? c.map((e, t) => /* @__PURE__ */ (0, Y.jsxs)("article", {
					...
					children: [
						/* @__PURE__ */ (0, Y.jsx)(Vg, { value: e.outcome }),
						...
						/* @__PURE__ */ (0, Y.jsx)("time", { children: Ig(e.at) })
					]
				}, `${e.at}-${t}`)) : /* @__PURE__ */ (0, Y.jsx)(S_, { label: "No scheduled delivery activity recorded yet." })
			})
		}),
		u && /* @__PURE__ */ (0, Y.jsx)(R_, {
			stage: u,
			content: m,
			error: g,
			loading: v,
...
function k_({ data: e, project: t, notify: n, reload: r }) {
	let i = e.patch || {}, a = i.current || {}, o = i.runs || [], s = i.scheduler_activity || [], c = !!a.active || /in_progress|running/i.test(String(a.patch_status || "")), [l, u] = (0, F.useState)(""), [d, f] = (0, F.useState)(""), [p, m] = (0, F.useState)(!1), [h, g] = (0, F.useState)(!1), [_, v] = (0, F.useState)(null), [y, b] = (0, F.useState)(""), [x, S] = (0, F.useState)(""), [C, w] = (0, F.useState)(!1), [T, E] = (0, F.useState)(!1), [ee, D] = (0, F.useState)(""), [O, k] = (0, F.useState)([]), [A, j] = (0, F.useState)(""), M = async (e = String(a.run_id || "")) => {
		m(!0), u(""), f("");
		try {
			let n = await Bg(`/api/patch/log?run_id=${encodeURIComponent(e)}`, t);
		...
		w(!0), E(!0), D(""), k([]), j("");
		try {
			let e = await Bg("/api/patch/candidates", t), n = Array.isArray(e.candidates) ? e.candidates : [];
		...
		if (e) {
			b(e), S("");
			try {
				await Bg("/api/patch/history/delete", t, {
					method: "POST",
					json: { run_id: e }
	...
	return /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [
			...
			children: [
				/* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, Y.jsx)(z_, {
							label: "Status",
							value: /* @__PURE__ */ (0, Y.jsx)(Vg, { value: a.patch_status || "not started" })
						}),
						/* @__PURE__ */ (0, Y.jsx)(z_, {
							label: "Branch",
			...
			children: [x && /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("table", {
					...
					children: [/* @__PURE__ */ (0, Y.jsx)("thead", { children: /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
						...
						colSpan: 7,
						children: /* @__PURE__ */ (0, Y.jsx)(S_, { label: "No Auto Patch history yet." })
					}) }) })]
				})
			})]
		}),
		/* @__PURE__ */ (0, Y.jsx)(d_, {
			...
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				}, `${e.at}-${t}`)) : /* @__PURE__ */ (0, Y.jsx)(S_, { label: "No Auto Patch activity recorded yet." })
			})
		}),
		C && /* @__PURE__ */ (0, Y.jsx)(A_, {
			candidates: O,
			selected: A,
			loading: T,
			error: ee,
...
function A_({ candidates: e, selected: t, loading: n, error: r, busy: i, onChange: a, onClose: o, onConfirm: s }) {
...
function j_({ phases: e, overallStatus: t }) {
	...
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("span", {
				...
				children: n.map((e, t) => {
					let n = String(e.status || "pending").toLowerCase(), i = r && n !== "completed" ? "skipped" : n === "completed" ? "completed" : /in_progress|running/.test(n) ? "running" : /failed|blocked/.test(n) ? "failed" : "pending", a = Q(e.detail || e.status, "Pending"), o = e.started_at ? Lg(e.started_at, e.finished_at || (/* @__PURE__ */ new Date()).toISOString()) : "—";
...
function M_({ stories: e, value: t, onChange: n, step: r, busy: i, error: a, onClose: o, onContinue: s, onConfirm: c }) {
...
function N_({ story: e, busy: t, error: n, onClose: r, onConfirm: i }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
...
function P_({ kind: e = "delivery", run: t, busy: n, onClose: r, onConfirm: i }) {
...
function F_({ project: e, notify: t, onDirtyChange: n }) {
	let r = new URLSearchParams(window.location.search).get("story") || "", [i, a] = (0, F.useState)([]), [o, s] = (0, F.useState)(r), [c, l] = (0, F.useState)(""), [u, d] = (0, F.useState)(""), [f, p] = (0, F.useState)(""), [m, h] = (0, F.useState)(""), [g, _] = (0, F.useState)(""), [v, y] = (0, F.useState)(""), [b, x] = (0, F.useState)(""), [S, C] = (0, F.useState)({
		story: "",
		plan: ""
	}), [w, T] = (0, F.useState)("story"), [E, ee] = (0, F.useState)(!0), [D, O] = (0, F.useState)(!1), [k, A] = (0, F.useState)(!1), [j, M] = (0, F.useState)(""), [N, te] = (0, F.useState)(!1), [ne, re] = (0, F.useState)(!1), [ie, ae] = (0, F.useState)(0), [P, oe] = (0, F.useState)(""), [se, ce] = (0, F.useState)(!1), [le, ue] = (0, F.useState)(""), de = v !== S.story || b !== S.plan, fe = h_(i.filter(g_)), pe = fe.length > 0;
	(0, F.useEffect)(() => {
		n(de);
	}, [de, n]), (0, F.useEffect)(() => {
		let e = (e) => {
	...
	let me = (0, F.useCallback)(async () => {
		ee(!0);
		try {
			let t = await Bg("/api/stories", e), n = Array.isArray(t.stories) ? t.stories : [];
		...
		if (n) {
			O(!0), T("story");
			try {
				let t = await Bg(`/api/stories/content?story=${encodeURIComponent(n)}`, e);
	...
	let ge = (e) => {
		...
		if (!(!o || !de)) {
			A(!0);
			try {
				let n = await Bg("/api/stories/content", e, {
					method: "POST",
					json: {
						story: o,
						story_markdown: v,
	...
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		...
		children: [
				...
				children: [
					...
					/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [
							...
							!E && !Se.length ? /* @__PURE__ */ (0, Y.jsx)(S_, { label: i.length ? "No stories match this filter." : "No stories found in the docs repository." }) : null,
							Se.map((e) => {
			...
			/* @__PURE__ */ (0, Y.jsx)("section", {
				...
				}), w === "story" ? /* @__PURE__ */ (0, Y.jsx)(l_, {
					value: v,
					onChange: y
				}, `${o || "none"}-story`) : /* @__PURE__ */ (0, Y.jsx)(l_, {
					value: b,
					onChange: x
				}, `${o || "none"}-plan`)] })] }) : /* @__PURE__ */ (0, Y.jsx)(S_, { label: "Select a story to inspect." })
			}),
			ie > 0 && /* @__PURE__ */ (0, Y.jsx)(M_, {
				stories: fe,
				value: P,
				onChange: oe,
				step: ie === 1 ? 1 : 2,
...
function L_({ stages: e, deliveryStatus: t, currentStep: n, startedAt: r, finishedAt: i, remediation: a, now: o, onStageClick: s }) {
	...
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
			...
			})] }), /* @__PURE__ */ (0, Y.jsxs)("p", { children: [r ? `Started ${Ig(r)}` : "Awaiting delivery trigger", i ? ` · Finished ${Ig(i)}` : ""] })]
		}), /* @__PURE__ */ (0, Y.jsxs)("div", {
			className: "flow-track-wrap",
			children: [/* @__PURE__ */ (0, Y.jsx)("span", {
				className: "flow-track",
...
function R_({ stage: e, content: t, error: n, loading: r, live: i = !1, onClose: a }) {
...
function V_({ checks: e, onClick: t }) {
...
function H_({ checks: e, onClose: t }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		onMouseDown: t,
...
function q_({ data: e, project: t, interact: n, notify: r }) {
	let i = e.interactive?.prompts || [], [a, o] = (0, F.useState)("scan"), [s, c] = (0, F.useState)(null), [l, u] = (0, F.useState)(""), [d, f] = (0, F.useState)(!1), [p, m] = (0, F.useState)({
		...
		c(e);
		try {
			let n = await Bg(`/api/prompt?mode=${encodeURIComponent(e.mode)}&path=${encodeURIComponent(e.path)}`, t);
			u(n.content);
		} catch (e) {
			...
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsx)("div", {
						...
						children: ee.map((e, t) => {
							let n = y.filter((t) => e.layers.includes(G_(t, a))), r = [...e.scripts.map((e) => ({
								kind: "script",
								script: e
							})), ...n.map((e) => ({
								kind: "prompt",
								...
								children: [
									...
									/* @__PURE__ */ (0, Y.jsx)("div", {
										...
										children: r.map((e, n) => {
											...
											let i = e.prompt, a = W_(i), o = a.icon;
											return /* @__PURE__ */ (0, Y.jsxs)("button", {
...
function J_({ item: e, content: t, saving: n, onChange: r, onClose: i, onSave: a }) {
	let o = W_(e);
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
				...
				/* @__PURE__ */ (0, Y.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, Y.jsx)("span", { children: "Preview" }), /* @__PURE__ */ (0, Y.jsx)(Qg, { content: t })]
						})]
					})
				}),
				/* @__PURE__ */ (0, Y.jsxs)("footer", { children: [/* @__PURE__ */ (0, Y.jsx)("button", {
...
function $({ label: e, help: t, children: n }) {
	return /* @__PURE__ */ (0, Y.jsxs)("label", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("span", {
			...
			children: [e, t && /* @__PURE__ */ (0, Y.jsx)(Y_, { children: t })]
		}), n]
	});
}
function X_({ options: e, value: t, onChange: n, markDirty: r }) {
...
function Z_({ label: e, value: t, onChange: n, markDirty: r }) {
	let i = Fg(t), a = Mg.some((e) => e.value === i), [o, s] = (0, F.useState)(!1), c = () => s(!0);
	return /* @__PURE__ */ (0, Y.jsxs)($, {
		...
		children: [
			/* @__PURE__ */ (0, Y.jsxs)("select", {
				value: a ? i : Ng,
				onChange: (e) => {
					e.target.value === Ng ? c() : (n(e.target.value), r());
				},
				children: [Mg.map((e) => /* @__PURE__ */ (0, Y.jsx)("option", {
					value: e.value,
					children: e.label
				}, e.value)), /* @__PURE__ */ (0, Y.jsx)("option", {
					value: Ng,
...
function Q_({ label: e, value: t, onClose: n, onConfirm: r }) {
				...
				children: [
					...
					/* @__PURE__ */ (0, Y.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							}), O.length === 0 && /* @__PURE__ */ (0, Y.jsx)(S_, { label: "No repositories match this view." })]
						})
					})
				]
			}),
										...
										children: [
											...
											/* @__PURE__ */ (0, Y.jsxs)("div", {
												...
												children: [
													...
													/* @__PURE__ */ (0, Y.jsx)(z_, {
														label: "Git status",
														value: /* @__PURE__ */ (0, Y.jsx)(Vg, { value: j.git_status || "unknown" })
													}),
													/* @__PURE__ */ (0, Y.jsx)(z_, {
														label: "Branch sync",
														value: /* @__PURE__ */ (0, Y.jsx)(Vg, { value: j.sync_status || "unknown" })
													})
												]
											}),
											/* @__PURE__ */ (0, Y.jsx)("div", {
...
function tv({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	...
	let Je = async (e) => {
		let n = await Bg(`/api/integration?key=${encodeURIComponent(e)}`, t);
		...
		if (!Ie) {
			...
			try {
				...
				}), ...Object.entries(pe).map(([e, n]) => () => Bg("/api/integration", t, {
					method: "POST",
					json: {
						key: e,
						value: n
				...
				})), at && e.push(() => Bg("/api/publish-policy", t, {
					method: "POST",
					json: {
						scan_mode: he,
						delivery_mode: _e,
			...
			/* @__PURE__ */ (0, Y.jsxs)(d_, {
				...
				children: [
					...
					we.length === 0 && /* @__PURE__ */ (0, Y.jsx)("div", {
						className: "settings-section divider",
						children: /* @__PURE__ */ (0, Y.jsx)(S_, { label: "No agent roles available yet." })
					})
				]
			}),
			/* @__PURE__ */ (0, Y.jsx)(d_, {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: /* @__PURE__ */ (0, Y.jsx)("div", {
							...
							children: Ze.length ? Ze.map((e) => {
								...
								return /* @__PURE__ */ (0, Y.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)(u_, {
											label: "Reveal value",
											onClick: () => void Ye(e),
							...
							}) : /* @__PURE__ */ (0, Y.jsx)(S_, { label: "No local integration keys configured." })
						})
					})]
				})
			}),
...
function nv({ enabled: e, onChange: t }) {
	return /* @__PURE__ */ (0, Y.jsxs)("label", {
...
(0, _e.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, Y.jsx)(f_, {}));
//#endregion
