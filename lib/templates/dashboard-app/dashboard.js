...
function Sv({ label: e, provider: t, model: n, baseUrl: r, apiKeyEnv: i, onProviderChange: a, onModelChange: o, onBaseUrlChange: s, onApiKeyEnvChange: c, markDirty: l }) {
	let { t: u } = Z(), d = (e) => {
		a(e), o(e === "opencode" ? "deepseek-v4-flash" : e === "cursor_cli" ? "cursor-grok-4.5-medium" : n), l();
	};
	return /* @__PURE__ */ (0, J.jsxs)("div", {
			...
			children: [
				...
				t === "opencode" && /* @__PURE__ */ (0, J.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, J.jsx)("code", { children: i || "DEEPSEEK_API_KEY" })
					]
				})
			]
		})]
								...
								children: /* @__PURE__ */ (0, J.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, J.jsxs)("div", { children: [/* @__PURE__ */ (0, J.jsx)("span", { children: a("settings.deepSeekCredential") }), /* @__PURE__ */ (0, J.jsxs)("strong", {
											...
											children: [
												Q(l.api_key_env, "DEEPSEEK_API_KEY"),
												" · ",
