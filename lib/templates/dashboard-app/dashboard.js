...
var le = /* @__PURE__ */ n(((e) => {
	...
	function Ac(e, t, n) {
		...
		switch (t.lanes = 0, t.tag) {
			...
			case 3:
				...
				return t;
			case 26: return fc(e, t), e === null ? (n = Nf(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : R || (n = t.type, e = t.pendingProps, r = Wd(ce.current).createElement(n), r[L] = t, r[ct] = e, Rd(r, n, e), bt(r), t.stateNode = r) : t.memoizedState = Nf(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
			...
			case 6:
				if (e && t.stateNode != null) e.memoizedProps !== r && jc(t);
					...
					if (e = ce.current, Hi(t)) {
						...
						e[L] = t, e = !!(e.nodeValue === n || r !== null && !0 === r.suppressHydrationWarning || Fd(e.nodeValue, n)), e || zi(t, !0);
					} else e = Wd(e).createTextNode(r), e[L] = t, t.stateNode = e;
				}
				return Ic(t), null;
			case 31:
				...
				if (hl(t, e), vl(e), r & 512 && (el || n === null || Gc(n, n.return)), r & 4) {
					...
					if (r = e.memoizedState, n === null) if (r === null) if (e.stateNode === null) {
						a: {
							...
							b: switch (r) {
								case "title":
									o = a.getElementsByTagName("title")[0], (!o || o[mt] || o[L] || o.namespaceURI === "http://www.w3.org/2000/svg" || o.hasAttribute("itemprop")) && (o = a.createElement(r), a.head.insertBefore(o, a.querySelector("head > title"))), Rd(o, r, n), o[L] = e, bt(o), r = o;
									break a;
								case "link":
	...
	function vd(e, t, n, r, i) {
		if (t === "submit" && n && n.stateNode === i) {
			var a = gd((i[ct] || null).action), o = r.submitter;
			o && (t = (t = o[ct] || null) ? gd(t.formAction) : o.getAttribute("formAction"), t !== null && (a = t, o = null));
...
function $g(e, t, n = "cursor-grok-4.5-medium") {
	...
	return {
		provider: String(o.provider || "cursor_cli"),
...
function xv({ label: e, value: t, provider: n = "cursor_cli", onChange: r, markDirty: i }) {
	let { t: a } = Z(), o = e_(t), s = n === "deepseek" || n === "deepseek_api" ? Xg : Yg, c = s.some((e) => e.value === o), l = o || a("customModel.option"), [u, d] = (0, F.useState)(!1), f = () => d(!0);
...
function Sv({ label: e, provider: t, model: n, baseUrl: r, apiKeyEnv: i, onProviderChange: a, onModelChange: o, onBaseUrlChange: s, onApiKeyEnvChange: c, markDirty: l }) {
	let { t: u } = Z(), d = (e) => {
		a(e), o(e === "deepseek" ? "deepseek-v4-flash" : e === "cursor_cli" ? "cursor-grok-4.5-medium" : n), l();
	};
	return /* @__PURE__ */ (0, J.jsxs)("div", {
...
function Ev({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	let { t: a } = Z(), o = e.interactive?.workspace || {}, s = e.interactive?.schedules || {}, c = e.interactive?.agents || {}, [l, u] = (0, F.useState)(String(o.scan_window_days || 7)), [d, f] = (0, F.useState)(String(s.scan?.cron || "0 12 * * 1-5")), [p, m] = (0, F.useState)(!!s.scan), [h, g] = (0, F.useState)(String(Math.round((s.delivery?.interval_seconds || 300) / 60))), [_, v] = (0, F.useState)(Array.isArray(s.delivery?.jira_statuses) ? s.delivery.jira_statuses.map(String) : String(s.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean)), [y, b] = (0, F.useState)(String(s.delivery?.in_dev_status || "")), [x, S] = (0, F.useState)(String(s.delivery?.dev_done_status || "")), [C, w] = (0, F.useState)(String(s.delivery?.blocked_status || "Block")), [T, E] = (0, F.useState)(!!s.delivery?.enabled), [ee, D] = (0, F.useState)(String(Math.round((s.patch?.interval_seconds || 300) / 60))), [O, te] = (0, F.useState)(Array.isArray(s.patch?.jira_statuses) ? s.patch.jira_statuses.map(String) : ["To Do"]), [k, A] = (0, F.useState)(String(s.patch?.in_progress_status || "In Progress")), [j, M] = (0, F.useState)(String(s.patch?.done_status || "Done")), [N, ne] = (0, F.useState)(String(s.patch?.blocked_status || "Block")), [re, ie] = (0, F.useState)(!!s.patch?.enabled), ae = $g(o, "scan"), [P, oe] = (0, F.useState)(ae.provider), [se, ce] = (0, F.useState)(ae.model), [le, ue] = (0, F.useState)(ae.base_url), [de, fe] = (0, F.useState)(ae.api_key_env), [pe, me] = (0, F.useState)([]), [he, ge] = (0, F.useState)({}), [_e, ve] = (0, F.useState)({}), [ye, be] = (0, F.useState)(String(o.publish?.scan || "pr")), [xe, Se] = (0, F.useState)(String(o.publish?.delivery || "pr")), [I, Ce] = (0, F.useState)(String(o.publish?.patch || "pr")), [we, Te] = (0, F.useState)(o.feishu_notifications_enabled !== !1), [Ee, De] = (0, F.useState)(!!o.deployment_tracking?.enabled), [Oe, ke] = (0, F.useState)(String(o.deployment_tracking?.provider || "none")), [Ae, je] = (0, F.useState)(String(o.deployment_tracking?.poll_interval_seconds || 30)), [Me, Ne] = (0, F.useState)(String(o.deployment_tracking?.timeout_seconds || 3600)), [Pe, Fe] = (0, F.useState)(String(o.deployment_tracking?.jenkins?.job || "")), [Ie, Le] = (0, F.useState)(String(o.deployment_tracking?.github_actions?.repository || "")), [Re, ze] = (0, F.useState)(String(o.deployment_tracking?.github_actions?.workflow || "")), [Be, Ve] = (0, F.useState)(!!c.enabled), [He, Ue] = (0, F.useState)(Array.isArray(c.agents) ? c.agents.map((e) => ({ ...e })) : []), [We, Ge] = (0, F.useState)({
	...
	}), [Je, Ye] = (0, F.useState)(""), [Xe, Ze] = (0, F.useState)(""), [Qe, $e] = (0, F.useState)({
		enabled: !!c.enabled,
	...
	}), [nt, rt] = (0, F.useState)(""), [it, at] = (0, F.useState)(!1), [ot, st] = (0, F.useState)(!1), L = () => {
		st(!0), r(!0);
	}, ct = (e) => {
		let t = String(Ke.names?.[e] || "").trim();
		if (t) return t;
		let n = (Ke.users || []).find((t) => t.id === e);
		if (n?.name) return String(n.name).trim();
		let r = (Ke.chats || []).find((t) => t.id === e);
		return String(r?.name || "").trim();
	}, lt = (e) => {
		let t = String(e || "").trim();
		return t.length <= 14 ? t : `${t.slice(0, 10)}…${t.slice(-4)}`;
	}, ut = (Ke.users?.length ? Ke.users : Ke.user_ids.map((e) => ({
		id: e,
		name: ct(e)
	}))).filter((e) => e.id), dt = (Ke.chats?.length ? Ke.chats : Ke.chat_ids.map((e) => ({
		id: e,
		name: ct(e)
	}))).filter((e) => e.id), ft = Array.from(/* @__PURE__ */ new Set([
		...We.allowed_user_ids || [],
		...We.mutation_allowed_user_ids || [],
		...We.admin_user_ids || []
	])), pt = /* @__PURE__ */ new Map();
	for (let e of ut) e.id && pt.set(String(e.id), e);
	for (let e of ft) pt.has(e) || pt.set(e, {
		id: e,
		name: ct(e)
	});
	let mt = Array.from(pt.values()).filter((e) => e.id), ht = [];
	for (let e of mt) {
		let t = String(e.id), n = String(e.name || ct(t) || a("common.unknown")), r = ht.find((e) => e.name === n);
		r ? r.ids.push(t) : ht.push({
			name: n,
			ids: [t]
		});
	}
	let gt = Array.from(/* @__PURE__ */ new Set([...We.allowed_chat_ids || [], ...Ke.chat_ids || []])).map((e) => dt.find((t) => String(t.id) === e) || {
		id: e,
		name: ct(e)
	}), _t = (e, t) => (We[e] || []).includes(t), vt = (e, t, n) => {
		Ge((r) => {
			let i = r[e] || [];
			return {
				...r,
	...
	}, yt = ht.filter((e) => e.ids.some((e) => ft.includes(e))), bt = (e) => {
	...
	(0, F.useEffect)(() => {
		o_("/api/delivery/status-options", t).then((e) => me(Array.isArray(e.options) ? e.options.map(String) : [])).catch(() => me([]));
	}, [t]), (0, F.useEffect)(() => {
		let e = !1;
		...
		let t = $g(o, "scan");
		u(String(o.scan_window_days || 7)), f(String(s.scan?.cron || "0 12 * * 1-5")), m(!!s.scan), g(String(Math.round((s.delivery?.interval_seconds || 300) / 60))), v(Array.isArray(s.delivery?.jira_statuses) ? s.delivery.jira_statuses.map(String) : String(s.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean)), b(String(s.delivery?.in_dev_status || "")), S(String(s.delivery?.dev_done_status || "")), w(String(s.delivery?.blocked_status || "Block")), E(!!s.delivery?.enabled), D(String(Math.round((s.patch?.interval_seconds || 300) / 60))), te(Array.isArray(s.patch?.jira_statuses) ? s.patch.jira_statuses.map(String) : ["To Do"]), A(String(s.patch?.in_progress_status || "In Progress")), M(String(s.patch?.done_status || "Done")), ne(String(s.patch?.blocked_status || "Block")), ie(!!s.patch?.enabled), oe(t.provider), ce(t.model), ue(t.base_url), fe(t.api_key_env), Te(o.feishu_notifications_enabled !== !1), ge({}), ve({}), e.interactive?.agents && bt(e.interactive.agents), st(!1), r(!1);
	}, [t]), (0, F.useEffect)(() => {
		be(String(o.publish?.scan || "pr")), Se(String(o.publish?.delivery || "pr")), Ce(String(o.publish?.patch || "pr"));
	}, [
		o.publish?.scan,
		o.publish?.delivery,
		o.publish?.patch
	]), (0, F.useEffect)(() => {
		Te(o.feishu_notifications_enabled !== !1);
	}, [o.feishu_notifications_enabled]), (0, F.useEffect)(() => {
		let e = o.deployment_tracking || {};
		De(!!e.enabled), ke(String(e.provider || "none")), je(String(e.poll_interval_seconds || 30)), Ne(String(e.timeout_seconds || 3600)), Fe(String(e.jenkins?.job || "")), Le(String(e.github_actions?.repository || "")), ze(String(e.github_actions?.workflow || ""));
	}, [JSON.stringify(o.deployment_tracking || {})]), (0, F.useEffect)(() => {
		let e = (e) => {
			ot && (e.preventDefault(), e.returnValue = "");
		};
		return window.addEventListener("beforeunload", e), () => window.removeEventListener("beforeunload", e);
	}, [ot]);
	let St = async (e) => {
	...
	}, Tt = o.configured_integrations || [], Et = o.integration_sources || {}, Dt = Tt.includes("JENKINS_URL") && Tt.includes("JENKINS_AUTH"), Ot = Array.from(new Set([
		"To Do",
		"Backlog",
		"In Progress",
		"Done",
		...
		j,
		N
	].filter(Boolean))), kt = Array.isArray(s.delivery?.jira_statuses) ? s.delivery.jira_statuses.map(String) : String(s.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean), At = Array.isArray(s.patch?.jira_statuses) ? s.patch.jira_statuses.map(String) : ["To Do"], jt = (e, t) => e.length === t.length && e.every((e, n) => e === t[n]), Mt = p !== !!s.scan || p && d !== String(s.scan?.cron || "0 12 * * 1-5"), Nt = T !== !!s.delivery?.enabled || T && (h !== String(Math.round((s.delivery?.interval_seconds || 300) / 60)) || !jt(_, kt) || y !== String(s.delivery?.in_dev_status || "") || x !== String(s.delivery?.dev_done_status || "") || C !== String(s.delivery?.blocked_status || "Block")), Pt = re !== !!s.patch?.enabled || re && (ee !== String(Math.round((s.patch?.interval_seconds || 300) / 60)) || !jt(O, At) || k !== String(s.patch?.in_progress_status || "In Progress") || j !== String(s.patch?.done_status || "Done") || N !== String(s.patch?.blocked_status || "Block")), Ft = ye !== String(o.publish?.scan || "pr") || xe !== String(o.publish?.delivery || "pr") || I !== String(o.publish?.patch || "pr"), It = {
		enabled: Ee,
		provider: Oe,
		poll_interval_seconds: Number(Ae),
		timeout_seconds: Number(Me),
		jenkins: { job: Pe },
		github_actions: {
			repository: Ie,
			workflow: Re
		}
	}, Lt = o.deployment_tracking || {}, Rt = JSON.stringify(It) !== JSON.stringify({
		enabled: !!Lt.enabled,
		provider: String(Lt.provider || "none"),
		poll_interval_seconds: Number(Lt.poll_interval_seconds || 30),
		timeout_seconds: Number(Lt.timeout_seconds || 3600),
		jenkins: { job: String(Lt.jenkins?.job || "") },
		github_actions: {
			repository: String(Lt.github_actions?.repository || ""),
			workflow: String(Lt.github_actions?.workflow || "")
		}
	}), zt = Be !== Qe.enabled || JSON.stringify(He) !== Qe.agents || JSON.stringify(We) !== Qe.access || JSON.stringify({
		language: et.language || "zh-Hant",
		table_name: et.table_name || "Sheet1",
		base_app_token_env: et.base_app_token_env || "FEISHU_MBPASS_QA_SHEET_TOKEN"
	}) !== (() => {
		try {
			let e = JSON.parse(Qe.testCase || "{}");
		...
		if (!it) {
			at(!0);
			try {
				if (!se.trim()) throw Error("Choose a preset or enter a supported global model ID.");
				let e = [() => o_("/api/workspace", t, {
					...
					json: {
						...
						ai_model: se.trim(),
						ai_base_url: le.trim(),
						ai_api_key_env: de.trim(),
						feishu_notifications_enabled: we
					}
				}), ...Object.entries(_e).map(([e, n]) => () => o_("/api/integration", t, {
					method: "POST",
					json: {
						key: e,
						value: n
				...
				})), Ft && e.push(() => o_("/api/publish-policy", t, {
					method: "POST",
					json: {
						scan_mode: ye,
						delivery_mode: xe,
				...
				})), Rt && e.push(() => o_("/api/deployment-config", t, {
					method: "POST",
					json: It
				})), zt && e.push(async () => {
					let e = await o_("/api/agents", t, {
						...
						json: {
							...
							test_case: {
								...
								table_name: et.table_name || "Sheet1",
								base_app_token_env: et.base_app_token_env || "FEISHU_MBPASS_QA_SHEET_TOKEN",
								...nt.trim() ? { base_app_token: nt.trim() } : {}
							},
							agents: He.map((e) => {
								let t = {
									id: e.id,
				...
				ve({}), st(!1), r(!1), n("Settings saved", "success"), i();
			} catch (e) {
		...
		T,
		re
	].filter(Boolean).length, Ht = He.filter((e) => e.conversation_enabled).length;
	return /* @__PURE__ */ (0, J.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, J.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, J.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, J.jsxs)("strong", { children: [Vt, "/3"] }),
					...
					/* @__PURE__ */ (0, J.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, J.jsx)("strong", { children: a(xe === "direct" ? "settings.direct" : xe === "merge" ? "settings.merge" : "settings.pullRequest") }),
						/* @__PURE__ */ (0, J.jsx)("small", { children: a("label.autoDelivery") })
					] }),
					/* @__PURE__ */ (0, J.jsxs)("div", { children: [
						/* @__PURE__ */ (0, J.jsx)("span", { children: a("common.integrations") }),
						/* @__PURE__ */ (0, J.jsx)("strong", { children: Tt.length }),
										...
										children: [
											...
											/* @__PURE__ */ (0, J.jsx)($, {
												...
												children: /* @__PURE__ */ (0, J.jsx)("select", {
													...
													children: Ot.map((e) => /* @__PURE__ */ (0, J.jsx)("option", {
														value: e,
														children: e
													}, e))
												})
											...
											/* @__PURE__ */ (0, J.jsx)($, {
												...
												children: /* @__PURE__ */ (0, J.jsx)("select", {
													...
													children: Array.from(/* @__PURE__ */ new Set([...Ot, "Block"])).map((e) => /* @__PURE__ */ (0, J.jsx)("option", {
														value: e,
														children: e
													}, e))
												})
						...
						/* @__PURE__ */ (0, J.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, J.jsxs)("div", {
									...
									}), /* @__PURE__ */ (0, J.jsx)("p", { children: re ? `Polling every ${ee} minute(s) for Task and Bug cards.` : a("settings.patchPaused") })]
								}),
								/* @__PURE__ */ (0, J.jsxs)("div", {
									className: "settings-control wide",
									children: [/* @__PURE__ */ (0, J.jsxs)("div", {
			...
			/* @__PURE__ */ (0, J.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, J.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, J.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, J.jsxs)("div", {
								...
								children: [
									...
									!!(We.legacy_warning ?? c.access?.legacy_warning) && /* @__PURE__ */ (0, J.jsx)("p", {
										className: "schedule-note",
								...
								children: [
									/* @__PURE__ */ (0, J.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, J.jsx)($, {
											...
											children: /* @__PURE__ */ (0, J.jsxs)("select", {
												...
												}), ht.map((e) => /* @__PURE__ */ (0, J.jsx)("optgroup", {
											...
											children: /* @__PURE__ */ (0, J.jsxs)("select", {
												...
												}), gt.map((e) => /* @__PURE__ */ (0, J.jsx)("option", {
													value: String(e.id),
													children: e.name || ct(String(e.id)) || lt(String(e.id))
												}, String(e.id)))]
											})
										})]
									}),
									Je && /* @__PURE__ */ (0, J.jsxs)("div", {
										className: "access-identity-editor",
										children: [
											/* @__PURE__ */ (0, J.jsxs)("div", {
												className: "access-identity-heading",
												children: [/* @__PURE__ */ (0, J.jsx)("span", { children: a("settings.identityRoles") }), /* @__PURE__ */ (0, J.jsx)("code", { children: lt(Je) })]
											}),
											/* @__PURE__ */ (0, J.jsxs)("label", { children: [/* @__PURE__ */ (0, J.jsx)("input", {
												type: "checkbox",
												checked: _t("allowed_user_ids", Je),
												onChange: (e) => vt("allowed_user_ids", Je, e.target.checked)
											}), a("settings.canTalk")] }),
											/* @__PURE__ */ (0, J.jsxs)("label", { children: [/* @__PURE__ */ (0, J.jsx)("input", {
												type: "checkbox",
												checked: _t("mutation_allowed_user_ids", Je),
												onChange: (e) => vt("mutation_allowed_user_ids", Je, e.target.checked)
											}), a("settings.canMutate")] }),
											/* @__PURE__ */ (0, J.jsxs)("label", { children: [/* @__PURE__ */ (0, J.jsx)("input", {
												type: "checkbox",
												checked: _t("admin_user_ids", Je),
												onChange: (e) => vt("admin_user_ids", Je, e.target.checked)
											}), a("settings.canAdmin")] })
										]
									}),
									Xe && /* @__PURE__ */ (0, J.jsxs)("div", {
										className: "access-identity-editor",
										children: [/* @__PURE__ */ (0, J.jsxs)("div", {
											className: "access-identity-heading",
											children: [/* @__PURE__ */ (0, J.jsx)("span", { children: a("settings.accessChat") }), /* @__PURE__ */ (0, J.jsx)("code", { children: lt(Xe) })]
										}), /* @__PURE__ */ (0, J.jsxs)("label", { children: [/* @__PURE__ */ (0, J.jsx)("input", {
											type: "checkbox",
											checked: (We.allowed_chat_ids || []).includes(Xe),
											onChange: (e) => vt("allowed_chat_ids", Xe, e.target.checked)
										}), a("settings.allowChat")] })]
									}),
									yt.length > 0 && /* @__PURE__ */ (0, J.jsxs)("div", {
										className: "access-summary",
										children: [/* @__PURE__ */ (0, J.jsxs)("div", {
											className: "access-identity-heading",
											children: [/* @__PURE__ */ (0, J.jsx)("span", { children: a("settings.accessSummary") }), /* @__PURE__ */ (0, J.jsx)("small", { children: a("settings.identityCount", { count: yt.reduce((e, t) => e + t.ids.length, 0) }) })]
										}), yt.map((e) => /* @__PURE__ */ (0, J.jsxs)("button", {
											type: "button",
											...
											children: [
												...
												/* @__PURE__ */ (0, J.jsxs)("em", { children: [
													[
														...
														"admin_user_ids"
													].filter((t) => e.ids.some((e) => _t(t, e))).length,
													" ",
									...
									mt.length === 0 && /* @__PURE__ */ (0, J.jsx)("p", {
						...
						He.map((e) => /* @__PURE__ */ (0, J.jsxs)("div", {
							...
							children: [
									...
									children: /* @__PURE__ */ (0, J.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, J.jsx)($, {
											...
											children: /* @__PURE__ */ (0, J.jsx)("input", {
												...
												onChange: (t) => xt(e.id, { app_id: t.target.value })
											})
										}), /* @__PURE__ */ (0, J.jsx)($, {
											...
											children: /* @__PURE__ */ (0, J.jsx)("input", {
												...
												onChange: (t) => xt(e.id, { app_secret: t.target.value }),
								...
								/* @__PURE__ */ (0, J.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, J.jsx)(Dv, {
										...
										onChange: (t) => xt(e.id, { conversation_enabled: t })
									})
								})
							]
						}, e.id)),
						He.length === 0 && /* @__PURE__ */ (0, J.jsx)("div", {
							className: "settings-section divider",
							...
							children: [/* @__PURE__ */ (0, J.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, J.jsx)($, {
										...
										help: et.base_app_token_configured ? `Configured (${et.base_app_token_masked || "set"}). Leave blank to keep. Env: ${et.base_app_token_env || "FEISHU_MBPASS_QA_SHEET_TOKEN"}` : `Stored in ~/.lumon/.env.local as ${et.base_app_token_env || "FEISHU_MBPASS_QA_SHEET_TOKEN"}`,
										children: /* @__PURE__ */ (0, J.jsx)("input", {
											value: nt,
											placeholder: et.base_app_token_configured ? "Leave blank to keep current token" : "https://…/sheets/TOKEN or TOKEN",
											onChange: (e) => {
												rt(e.target.value), L();
											},
											autoComplete: "off"
										...
										children: [
											/* @__PURE__ */ (0, J.jsx)($, {
												...
												children: /* @__PURE__ */ (0, J.jsxs)("select", {
													value: Oe,
													onChange: (e) => {
														ke(e.target.value), De(e.target.value !== "none"), L();
													},
													children: [
														/* @__PURE__ */ (0, J.jsx)("option", {
															value: "none",
											...
											Oe === "jenkins" && /* @__PURE__ */ (0, J.jsxs)(J.Fragment, { children: [/* @__PURE__ */ (0, J.jsx)($, {
												...
												children: [
													/* @__PURE__ */ (0, J.jsxs)("div", { children: [/* @__PURE__ */ (0, J.jsx)("span", {
														...
														className: `integration-status${Dt ? " is-configured" : ""}`,
														children: a(Dt ? "settings.configured" : "settings.notConfigured")
													})] }),
													/* @__PURE__ */ (0, J.jsx)("code", { children: "JENKINS_URL + JENKINS_AUTH" }),
													/* @__PURE__ */ (0, J.jsx)("p", { children: a("settings.jenkinsCredentials") })
												]
											})] }),
											Oe === "github_actions" && /* @__PURE__ */ (0, J.jsxs)(J.Fragment, { children: [
												/* @__PURE__ */ (0, J.jsx)($, {
						...
						children: /* @__PURE__ */ (0, J.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, J.jsxs)("div", {
								...
								children: /* @__PURE__ */ (0, J.jsx)("div", {
									...
									children: Tt.length ? Tt.map((e) => {
										let t = _e[e] ?? he[e] ?? "", n = Et[e] === "lumon_local" ? a("settings.storedLumon") : a("settings.storedWorkspace");
										return /* @__PURE__ */ (0, J.jsxs)("div", {
											...
											children: [
												...
												/* @__PURE__ */ (0, J.jsx)("input", {
													type: he[e] || _e[e] !== void 0 ? "text" : "password",
													value: t,
												...
												/* @__PURE__ */ (0, J.jsxs)("div", { children: [/* @__PURE__ */ (0, J.jsx)(A_, {
													...
													onClick: () => void Ct(e),
													children: he[e] ? /* @__PURE__ */ (0, J.jsx)(Jh, { size: 15 }) : /* @__PURE__ */ (0, J.jsx)(Yh, { size: 15 })
												}), /* @__PURE__ */ (0, J.jsx)(A_, {
			...
			/* @__PURE__ */ (0, J.jsxs)("footer", {
				...
				children: [/* @__PURE__ */ (0, J.jsx)("span", {
					className: ot ? "settings-save-status unsaved" : "settings-save-status",
					children: a(it ? "common.saving" : ot ? "settings.unsavedChanges" : "settings.allSaved")
				}), /* @__PURE__ */ (0, J.jsxs)("button", {
					className: `button primary${it ? " is-busy" : ""}`,
					disabled: !ot || it,
					onClick: () => void Bt(),
					children: [it ? /* @__PURE__ */ (0, J.jsx)(ag, {
						size: 15,
						className: "spin"
					}) : /* @__PURE__ */ (0, J.jsx)(ug, { size: 15 }), a(it ? "common.saving" : "action.saveChanges")]
				})]
			})
		]
	});
