...
function kv({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	let { t: a } = Z(), o = e.interactive?.workspace || {}, s = e.interactive?.schedules || {}, c = e.interactive?.agents || {}, l = o.runtime && typeof o.runtime == "object" ? o.runtime : {}, [u, d] = (0, F.useState)(String(o.scan_window_days || 7)), [f, p] = (0, F.useState)(String(s.scan?.cron || "0 12 * * 1-5")), [m, h] = (0, F.useState)(!!s.scan), [g, _] = (0, F.useState)(String(Math.round((s.delivery?.interval_seconds || 300) / 60))), [v, y] = (0, F.useState)(Array.isArray(s.delivery?.jira_statuses) ? s.delivery.jira_statuses.map(String) : String(s.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean)), [b, x] = (0, F.useState)(String(s.delivery?.in_dev_status || "")), [S, C] = (0, F.useState)(String(s.delivery?.dev_done_status || "")), [w, T] = (0, F.useState)(String(s.delivery?.blocked_status || "Block")), [E, ee] = (0, F.useState)(!!s.delivery?.enabled), [D, O] = (0, F.useState)(String(Math.round((s.patch?.interval_seconds || 300) / 60))), [te, k] = (0, F.useState)(Array.isArray(s.patch?.jira_statuses) ? s.patch.jira_statuses.map(String) : ["To Do"]), [A, j] = (0, F.useState)(String(s.patch?.in_progress_status || "In Progress")), [M, N] = (0, F.useState)(String(s.patch?.done_status || "Done")), [ne, re] = (0, F.useState)(String(s.patch?.blocked_status || "Block")), [ie, ae] = (0, F.useState)(!!s.patch?.enabled), P = n_(o, "scan"), [oe, se] = (0, F.useState)(P.provider), [ce, le] = (0, F.useState)(P.model), [ue, de] = (0, F.useState)(P.base_url), [fe, pe] = (0, F.useState)(P.api_key_env), [me, he] = (0, F.useState)(P.reasoning_effort), [ge, _e] = (0, F.useState)(P.account_email), [ve, ye] = (0, F.useState)([]), [be, xe] = (0, F.useState)({}), [Se, I] = (0, F.useState)({}), [Ce, we] = (0, F.useState)(String(o.publish?.scan || "pr")), [Te, Ee] = (0, F.useState)(String(o.publish?.delivery || "pr")), [De, Oe] = (0, F.useState)(String(o.publish?.patch || "pr")), [ke, Ae] = (0, F.useState)(o.feishu_notifications_enabled !== !1), [je, Me] = (0, F.useState)(!!o.deployment_tracking?.enabled), [Ne, Pe] = (0, F.useState)(String(o.deployment_tracking?.provider || "none")), [Fe, Ie] = (0, F.useState)(String(o.deployment_tracking?.poll_interval_seconds || 30)), [Le, Re] = (0, F.useState)(String(o.deployment_tracking?.timeout_seconds || 3600)), [ze, Be] = (0, F.useState)(String(o.deployment_tracking?.jenkins?.job || "")), [Ve, He] = (0, F.useState)(String(o.deployment_tracking?.github_actions?.repository || "")), [Ue, We] = (0, F.useState)(String(o.deployment_tracking?.github_actions?.workflow || "")), [Ge, Ke] = (0, F.useState)(!!c.enabled), [qe, Je] = (0, F.useState)(Array.isArray(c.agents) ? c.agents.map((e) => ({ ...e })) : []), [Ye, Xe] = (0, F.useState)({
		...
		id: e,
		name: dt(e)
	}))).filter((e) => e.id), mt = (Ze.chats?.length ? Ze.chats : Ze.chat_ids.map((e) => ({
		id: e,
		name: dt(e)
	}))).filter((e) => e.id), ht = Array.from(/* @__PURE__ */ new Set([
		...Ye.allowed_user_ids || [],
		...Ye.mutation_allowed_user_ids || [],
		...Ye.admin_user_ids || []
	])), gt = /* @__PURE__ */ new Map();
	for (let e of pt) e.id && gt.set(String(e.id), e);
	for (let e of ht) gt.has(e) || gt.set(e, {
		id: e,
		name: dt(e)
	});
	let _t = Array.from(gt.values()).filter((e) => e.id), vt = [];
	for (let e of _t) {
		let t = String(e.id), n = String(e.union_id || "").trim() || `id:${t}`, r = a("settings.pendingAccess"), i = String(e.name || dt(t) || r), o = vt.find((e) => e.key === n);
		o ? (o.ids.push(t), i !== r && (o.name = i)) : vt.push({
			key: n,
			name: i,
			ids: [t],
			pending: !1
	...
	for (let e of vt) e.pending = e.ids.some((e) => !ht.includes(e));
	let yt = Array.from(/* @__PURE__ */ new Set([...Ze.chat_ids || [], ...Ye.allowed_chat_ids || []])).map((e) => mt.find((t) => String(t.id) === e) || {
		id: e,
		name: dt(e),
		agents: []
	}), bt = (e, t) => (Ye[e] || []).includes(t), xt = (e, t, n) => {
		Xe((r) => {
			let i = r[e] || [];
			return {
				...r,
	...
	}, St = vt.filter((e) => e.ids.some((e) => ht.includes(e))), Ct = (e) => {
	...
	let Tt = async (e) => {
	...
	}, Ot = o.configured_integrations || [], kt = o.integration_sources || {}, At = Ot.includes("JENKINS_URL") && Ot.includes("JENKINS_AUTH"), jt = Array.from(new Set([
		"To Do",
		"Backlog",
		"In Progress",
		"Done",
		...
		M,
		ne
	].filter(Boolean))), Mt = Array.isArray(s.delivery?.jira_statuses) ? s.delivery.jira_statuses.map(String) : String(s.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean), Nt = Array.isArray(s.patch?.jira_statuses) ? s.patch.jira_statuses.map(String) : ["To Do"], Pt = (e, t) => e.length === t.length && e.every((e, n) => e === t[n]), Ft = m !== !!s.scan || m && f !== String(s.scan?.cron || "0 12 * * 1-5"), It = E !== !!s.delivery?.enabled || E && (g !== String(Math.round((s.delivery?.interval_seconds || 300) / 60)) || !Pt(v, Mt) || b !== String(s.delivery?.in_dev_status || "") || S !== String(s.delivery?.dev_done_status || "") || w !== String(s.delivery?.blocked_status || "Block")), Lt = ie !== !!s.patch?.enabled || ie && (D !== String(Math.round((s.patch?.interval_seconds || 300) / 60)) || !Pt(te, Nt) || A !== String(s.patch?.in_progress_status || "In Progress") || M !== String(s.patch?.done_status || "Done") || ne !== String(s.patch?.blocked_status || "Block")), Rt = Ce !== String(o.publish?.scan || "pr") || Te !== String(o.publish?.delivery || "pr") || De !== String(o.publish?.patch || "pr"), zt = {
		enabled: je,
		provider: Ne,
	...
	}, Bt = o.deployment_tracking || {}, Vt = JSON.stringify(zt) !== JSON.stringify({
		enabled: !!Bt.enabled,
		provider: String(Bt.provider || "none"),
		poll_interval_seconds: Number(Bt.poll_interval_seconds || 30),
		timeout_seconds: Number(Bt.timeout_seconds || 3600),
		jenkins: { job: String(Bt.jenkins?.job || "") },
		github_actions: {
			repository: String(Bt.github_actions?.repository || ""),
			workflow: String(Bt.github_actions?.workflow || "")
		}
	}), Ht = Ge !== tt.enabled || JSON.stringify(qe) !== tt.agents || JSON.stringify(Ye) !== tt.access || JSON.stringify({
		...
		if (!st) {
			...
			try {
				...
				})), Rt && e.push(() => l_("/api/publish-policy", t, {
					method: "POST",
					json: {
						scan_mode: Ce,
						delivery_mode: Te,
				...
				})), Vt && e.push(() => l_("/api/deployment-config", t, {
					method: "POST",
					json: zt
				})), Ht && e.push(async () => {
		...
		E,
		ie
	].filter(Boolean).length, Gt = qe.filter((e) => e.conversation_enabled).length;
	return /* @__PURE__ */ (0, J.jsxs)("div", {
			...
			/* @__PURE__ */ (0, J.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, J.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, J.jsxs)("strong", { children: [Wt, "/3"] }),
					...
					/* @__PURE__ */ (0, J.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, J.jsx)("strong", { children: Ot.length }),
										...
										children: [
											...
											/* @__PURE__ */ (0, J.jsx)($, {
												...
												children: /* @__PURE__ */ (0, J.jsx)("select", {
													...
													children: jt.map((e) => /* @__PURE__ */ (0, J.jsx)("option", {
														value: e,
														children: e
													}, e))
												})
											...
											/* @__PURE__ */ (0, J.jsx)($, {
												...
												children: /* @__PURE__ */ (0, J.jsx)("select", {
													...
													children: Array.from(/* @__PURE__ */ new Set([...jt, "Block"])).map((e) => /* @__PURE__ */ (0, J.jsx)("option", {
														value: e,
														children: e
													}, e))
												})
								...
								children: [
									/* @__PURE__ */ (0, J.jsx)("div", {
										...
										children: /* @__PURE__ */ (0, J.jsx)($, {
											...
											children: /* @__PURE__ */ (0, J.jsxs)("select", {
												...
												}), vt.map((e) => /* @__PURE__ */ (0, J.jsx)("optgroup", {
									...
									/* @__PURE__ */ (0, J.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, J.jsxs)("section", {
											...
											children: [/* @__PURE__ */ (0, J.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, J.jsxs)("div", { children: [/* @__PURE__ */ (0, J.jsx)("strong", { children: a("settings.groupChats") }), /* @__PURE__ */ (0, J.jsx)("span", { children: a("settings.groupChatsDescription") })] }), /* @__PURE__ */ (0, J.jsx)(u_, { value: `${yt.filter((e) => (Ye.allowed_chat_ids || []).includes(String(e.id))).length}/${yt.length}` })]
											}), /* @__PURE__ */ (0, J.jsx)("div", {
												className: "access-list",
												children: yt.length ? yt.map((e) => {
													...
													return /* @__PURE__ */ (0, J.jsxs)("label", {
														...
														children: [/* @__PURE__ */ (0, J.jsxs)("span", {
															...
															onChange: (e) => xt("allowed_chat_ids", t, e.target.checked),
											...
											children: [/* @__PURE__ */ (0, J.jsxs)("div", {
												className: "access-permission-heading",
												children: [/* @__PURE__ */ (0, J.jsxs)("div", { children: [/* @__PURE__ */ (0, J.jsx)("strong", { children: a("settings.privateContacts") }), /* @__PURE__ */ (0, J.jsx)("span", { children: a("settings.privateContactsDescription") })] }), /* @__PURE__ */ (0, J.jsx)(u_, { value: `${_t.filter((e) => bt("allowed_user_ids", String(e.id))).length}/${_t.length}` })]
											}), /* @__PURE__ */ (0, J.jsx)("div", {
												className: "access-list",
												children: _t.length ? _t.map((e) => {
													...
													return /* @__PURE__ */ (0, J.jsxs)("label", {
														...
														children: [/* @__PURE__ */ (0, J.jsxs)("span", {
															...
															type: "checkbox",
															checked: bt("allowed_user_ids", t),
															onChange: (e) => xt("allowed_user_ids", t, e.target.checked),
									...
									$e && /* @__PURE__ */ (0, J.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, J.jsxs)("label", { children: [/* @__PURE__ */ (0, J.jsx)("input", {
												type: "checkbox",
												checked: bt("allowed_user_ids", $e),
												onChange: (e) => xt("allowed_user_ids", $e, e.target.checked)
											}), a("settings.canTalk")] }),
											/* @__PURE__ */ (0, J.jsxs)("label", { children: [/* @__PURE__ */ (0, J.jsx)("input", {
												type: "checkbox",
												checked: bt("mutation_allowed_user_ids", $e),
												onChange: (e) => xt("mutation_allowed_user_ids", $e, e.target.checked)
											}), a("settings.canMutate")] }),
											/* @__PURE__ */ (0, J.jsxs)("label", { children: [/* @__PURE__ */ (0, J.jsx)("input", {
												type: "checkbox",
												checked: bt("admin_user_ids", $e),
												onChange: (e) => xt("admin_user_ids", $e, e.target.checked)
											}), a("settings.canAdmin")] })
										]
									}),
									St.length > 0 && /* @__PURE__ */ (0, J.jsxs)("div", {
										className: "access-summary",
										children: [/* @__PURE__ */ (0, J.jsxs)("div", {
											className: "access-identity-heading",
											children: [/* @__PURE__ */ (0, J.jsx)("span", { children: a("settings.accessSummary") }), /* @__PURE__ */ (0, J.jsx)("small", { children: a("settings.identityCount", { count: St.reduce((e, t) => e + t.ids.length, 0) }) })]
										}), St.map((e) => /* @__PURE__ */ (0, J.jsxs)("button", {
											type: "button",
											...
											children: [
												...
												/* @__PURE__ */ (0, J.jsxs)("em", { children: [
													[
														...
														"admin_user_ids"
													].filter((t) => e.ids.some((e) => bt(t, e))).length,
													" ",
							...
							children: [
									...
									children: /* @__PURE__ */ (0, J.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, J.jsx)($, {
											...
											children: /* @__PURE__ */ (0, J.jsx)("input", {
												...
												onChange: (t) => wt(e.id, { app_id: t.target.value })
											})
										}), /* @__PURE__ */ (0, J.jsx)($, {
											...
											children: /* @__PURE__ */ (0, J.jsx)("input", {
												...
												onChange: (t) => wt(e.id, { app_secret: t.target.value }),
								...
								/* @__PURE__ */ (0, J.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, J.jsx)(Av, {
										...
										onChange: (t) => wt(e.id, { conversation_enabled: t })
									})
								})
							]
						}, e.id)),
											...
											Ne === "jenkins" && /* @__PURE__ */ (0, J.jsxs)(J.Fragment, { children: [/* @__PURE__ */ (0, J.jsx)($, {
												...
												children: [
													/* @__PURE__ */ (0, J.jsxs)("div", { children: [/* @__PURE__ */ (0, J.jsx)("span", {
														...
														className: `integration-status${At ? " is-configured" : ""}`,
														children: a(At ? "settings.configured" : "settings.notConfigured")
													})] }),
						...
						children: /* @__PURE__ */ (0, J.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, J.jsxs)("div", {
								...
								children: /* @__PURE__ */ (0, J.jsx)("div", {
									...
									children: Ot.length ? Ot.map((e) => {
										let t = Se[e] ?? be[e] ?? "", n = kt[e] === "lumon_local" ? a("settings.storedLumon") : a("settings.storedWorkspace");
										return /* @__PURE__ */ (0, J.jsxs)("div", {
